...
(assert (= earray_33 (store a elem_25 elem_32)))
(assert (= earray_35 (store earray_33 elem_22 elem_34)))
(assert (= earray_37 (store earray_35 elem_19 elem_36)))
(assert (= earray_39 (store earray_37 elem_16 elem_38)))
(assert (= earray_41 (store earray_39 elem_13 elem_40)))
(assert (= earray_43 (store earray_41 elem_10 elem_42)))
(assert (= earray_45 (store earray_43 elem_7 elem_44)))
(assert (= earray_47 (store earray_45 elem_4 elem_46)))
(assert (= earray_49 (store earray_47 elem_0 elem_48)))
(assert (= earray_51 (store earray_49 i elem_50)))
...
(assert (= elem_31 (select a elem_28)))
(assert (= elem_32 (- elem_31 1)))
...
(assert (= earray_30 earray_51))
(assert (not (= elem_29 elem_31)))
(check-sat)
(exit)
