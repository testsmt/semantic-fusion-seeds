...
(assert (= main_Q_0_Q_min_Q_2 (ite (and (and (bvult main_Q_0_Q_j_Q_1 (bvsub (_ bv2 32) (_ bv1 32))) (bvult main_Q_0_Q_i_Q_1 (_ bv2 32))) (bvult (select array_Q_2 main_Q_0_Q_i_Q_1) (select array_Q_2 main_Q_0_Q_min_Q_1))) main_Q_0_Q_i_Q_1 main_Q_0_Q_min_Q_1)))
...
(assert (= main_Q_0_Q_temp_Q_1 (ite (bvult main_Q_0_Q_j_Q_1 (bvsub (_ bv2 32) (_ bv1 32))) (select array_Q_2 main_Q_0_Q_j_Q_1) main_Q_0_Q_temp_Q_0)))
(declare-fun array_Q_3 () (Array (_ BitVec 32) (_ BitVec 32)))
(assert (= array_Q_3 (ite (bvult main_Q_0_Q_j_Q_1 (bvsub (_ bv2 32) (_ bv1 32))) (store array_Q_2 main_Q_0_Q_j_Q_1 (select array_Q_2 main_Q_0_Q_min_Q_2)) array_Q_2)))
(declare-fun array_Q_4 () (Array (_ BitVec 32) (_ BitVec 32)))
(assert (= array_Q_4 (ite (bvult main_Q_0_Q_j_Q_1 (bvsub (_ bv2 32) (_ bv1 32))) (store array_Q_3 main_Q_0_Q_min_Q_2 main_Q_0_Q_temp_Q_1) array_Q_3)))
...
(assert (let ((?v_5 (bvsub (_ bv2 32) (_ bv1 32)))) (let ((?v_2 (bvult main_Q_0_Q_j_Q_1 ?v_5)) (?v_0 (bvult main_Q_0_Q_i_Q_1 (_ bv2 32)))) (let ((?v_1 (and ?v_2 ?v_0)) (?v_6 (and (bvule (_ bv0 32) (_ bv0 32)) (bvult (_ bv0 32) (_ bv2 32)))) (?v_3 (=> ?v_2 (and (bvule (_ bv0 32) main_Q_0_Q_j_Q_1) (bvult main_Q_0_Q_j_Q_1 (_ bv2 32))))) (?v_4 (=> ?v_2 (and (bvule (_ bv0 32) main_Q_0_Q_min_Q_2) (bvult main_Q_0_Q_min_Q_2 (_ bv2 32))))) (?v_7 (bvadd (_ bv0 32) (_ bv1 32)))) (not (and (and (and (and (and (and (and (and (and (and (and (and ?v_6 (and (bvule (_ bv0 32) (_ bv1 32)) (bvult (_ bv1 32) (_ bv2 32)))) (=> ?v_1 (and (bvule (_ bv0 32) main_Q_0_Q_i_Q_1) ?v_0))) (=> ?v_1 (and (bvule (_ bv0 32) main_Q_0_Q_min_Q_1) (bvult main_Q_0_Q_min_Q_1 (_ bv2 32))))) (=> ?v_1 (not (bvult main_Q_0_Q_i_Q_2 (_ bv2 32))))) ?v_3) ?v_3) ?v_4) ?v_4) (=> ?v_2 (not (bvult main_Q_0_Q_j_Q_2 ?v_5)))) ?v_6) (and (bvule (_ bv0 32) ?v_7) (bvult ?v_7 (_ bv2 32)))) (bvule (select array_Q_4 (_ bv0 32)) (select array_Q_4 ?v_7))))))))
(check-sat)
(exit)
