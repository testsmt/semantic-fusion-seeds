...
(assert (= main_Q_0_Q_min_Q_2 (ite (and (and (bvult main_Q_0_Q_j_Q_1 (bvsub (_ bv2 32) (_ bv1 32))) (bvult main_Q_0_Q_i_Q_1 (_ bv2 32))) (bvult (select array_Q_0 main_Q_0_Q_min_Q_1) (select array_Q_0 main_Q_0_Q_i_Q_1))) main_Q_0_Q_i_Q_1 main_Q_0_Q_min_Q_1)))
