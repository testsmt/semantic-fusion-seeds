...
(assert (and true (= T4_478 (bvor (bvshl (bvor (bvshl (bvor (bvshl ((_ zero_extend 24) T1_481) (_ bv8 32)) ((_ zero_extend 24) T1_480)) (_ bv8 32)) ((_ zero_extend 24) T1_479)) (_ bv8 32)) ((_ zero_extend 24) T1_478))) (= T4_478 (_ bv12000 32)) (not (= T4_478 (_ bv16000 32))) (not (= T4_478 (_ bv24000 32))) (not (= T4_478 (_ bv32000 32))) (not (= T4_478 (_ bv48000 32))) (not (= T4_478 (_ bv11025 32))) (not (= T4_478 (_ bv22050 32))) (not (= T4_478 (_ bv44100 32))) (bvule T4_478 (_ bv48000 32))))
(check-sat)
(exit)
