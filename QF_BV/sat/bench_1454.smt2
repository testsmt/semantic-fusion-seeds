...
(assert (let ((?v_3 ((_ zero_extend 24) T1_3993)) (?v_1 ((_ zero_extend 24) T1_3592))) (let ((?v_0 (bvadd ?v_1 (_ bv1 32)))) (let ((?v_2 (bvadd (bvadd ?v_0 (_ bv4268253 32)) ((_ zero_extend 16) T2_3601)))) (let ((?v_4 (bvadd ?v_2 (_ bv6 32)))) (let ((?v_6 (bvadd (bvadd ?v_4 (bvadd ?v_3 (_ bv1 32))) (_ bv2 32)))) (let ((?v_5 (bvadd ?v_6 ((_ zero_extend 16) T2_4002)))) (let ((?v_8 (bvadd ?v_5 (_ bv6 32))) (?v_7 ((_ zero_extend 24) T1_4038))) (and true (= T2_3601 (bvor (bvshl ((_ zero_extend 8) T1_3602) (_ bv8 16)) ((_ zero_extend 8) T1_3601))) (= T2_4002 (bvor (bvshl ((_ zero_extend 8) T1_4003) (_ bv8 16)) ((_ zero_extend 8) T1_4002))) (bvult (_ bv4269078 32) (bvadd (bvadd ?v_8 (bvadd ?v_7 (_ bv1 32))) (_ bv2 32))) (bvule (bvadd (bvadd ?v_0 (_ bv4268251 32)) (_ bv2 32)) (_ bv4269078 32)) (not (= ?v_1 (_ bv1 32))) (bvule (bvsub ?v_2 (_ bv4268232 32)) (_ bv846 32)) (not (= ?v_3 (_ bv1 32))) (bvule (bvadd ?v_4 (_ bv1 32)) (_ bv4269078 32)) (bvule (bvsub ?v_5 (_ bv4268232 32)) (_ bv846 32)) (bvule ?v_6 (_ bv4269078 32)) (= ?v_7 (_ bv1 32)) (bvule (bvadd ?v_8 (_ bv1 32)) (_ bv4269078 32)))))))))))
(check-sat)
(exit)
