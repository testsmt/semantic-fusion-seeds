...
(assert (let ((?v_0 (bvadd ((_ zero_extend 16) T2_10732) ((_ zero_extend 24) (_ bv1 8))))) (and true (= T2_10732 (bvor (bvshl ((_ zero_extend 8) T1_10733) (_ bv8 16)) ((_ zero_extend 8) T1_10732))) (bvsle (_ bv1024 32) ?v_0) (bvult (_ bv0 16) T2_10732) (bvsle ?v_0 (_ bv32768 32)) (bvslt (_ bv0 32) ?v_0) (bvsle (_ bv0 32) ?v_0) (not (= ?v_0 (_ bv0 32))) (bvule ?v_0 (_ bv2147483647 32)))))
(check-sat)
(exit)
