...
(assert (and true (= T2_234 (bvor (bvshl ((_ zero_extend 8) T1_235) (_ bv8 16)) ((_ zero_extend 8) T1_234))) (= T2_240 (bvor (bvshl ((_ zero_extend 8) T1_241) (_ bv8 16)) ((_ zero_extend 8) T1_240))) (= T2_468 (bvor (bvshl ((_ zero_extend 8) T1_469) (_ bv8 16)) ((_ zero_extend 8) T1_468))) (= T2_582 (bvor (bvshl ((_ zero_extend 8) T1_583) (_ bv8 16)) ((_ zero_extend 8) T1_582))) (bvult (_ bv63 16) T2_468) (bvsle (_ bv0 16) T2_582) (= T2_582 T2_240) (not (= T2_468 T2_240)) (not (= T2_240 T2_468)) (= T2_234 T2_468) (bvsle (_ bv0 16) T2_468)))
(check-sat)
(exit)
