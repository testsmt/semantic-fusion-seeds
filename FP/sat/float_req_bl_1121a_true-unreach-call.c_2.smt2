...
(assert (not (exists ((fmod_float_~x (_ FloatingPoint 8 24))) (= |c_fmod_float_#res| (let ((.cse0 (fp.mul c_currentRoundingMode fmod_float_~x |c_fmod_float_#in~y|))) (fp.div c_currentRoundingMode .cse0 .cse0))))))
(check-sat)
(exit)
