...
(define-fun coord__first () Float32 ((_ to_fp 8 24) #xc2c80000))
(define-fun coord__last () Float32 ((_ to_fp 8 24) #x42c80000))
(define-fun radius__first () Float32 (_ +zero 8 24))
(define-fun radius__last () Float32 ((_ to_fp 8 24) #x41200000))
...
(define-fun in_coord ((f Float32)) Bool (and (fp.geq f coord__first) (fp.leq f coord__last)))
(define-fun in_radius ((f Float32)) Bool (and (fp.geq f radius__first) (fp.leq f radius__last)))
...
(define-fun delta_x () Float32 (fp.abs (fp.sub RNE x c_x)))
(define-fun delta_y () Float32 (fp.abs (fp.sub RNE y c_y)))
