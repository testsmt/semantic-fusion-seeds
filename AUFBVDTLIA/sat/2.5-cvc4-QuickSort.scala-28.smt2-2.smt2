...
(assert (not (forall ((e!247 (_ BitVec 32)) (n!246 (_ BitVec 32))) (or (or (contains!209 (smaller!233 n!246 Nil!1242) e!247) (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) (smaller!233 n!246 Nil!1242)) (= (contains!209_arg_1_2 ?z) e!247))) ) (forall ((?z I_smaller!233)) (not (and (= (smaller!233_arg_0_3 ?z) n!246) (= (smaller!233_arg_1_4 ?z) Nil!1242))) )) (or (contains!209 Nil!1242 e!247) (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) Nil!1242) (= (contains!209_arg_1_2 ?z) e!247))) )) (bvslt e!247 n!246)) )))
(check-sat)
(exit)
