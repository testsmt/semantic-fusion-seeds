...
(assert (not (forall ((l!205 IList!903)) (not (and (bvslt (ite ((_ is Nil!907) (tail!906 l!205)) (_ bv0 32) (ite ((_ is Cons!904) l!205) (bvadd (listSize!206 l!205) (_ bv1 32)) error_value!909)) (_ bv0 32)) (ite ((_ is Nil!907) (tail!906 l!205)) true (ite ((_ is Cons!904) l!205) (not (forall ((?z I_listSize!206)) (not (= (listSize!206_arg_0_1 ?z) l!205)) )) true)))) )))
(check-sat)
(exit)
