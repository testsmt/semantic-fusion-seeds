...
(assert (not (forall ((l!205 TokenList!939)) (not (and (bvslt (ite ((_ is Nil!943) l!205) (_ bv0 32) (ite ((_ is Cons!940) l!205) error_value!954 (bvadd (size!206 (tail!942 l!205)) (_ bv1 32)))) (_ bv0 32)) (ite ((_ is Nil!943) l!205) true (ite ((_ is Cons!940) l!205) true (not (forall ((?z I_size!206)) (not (= (size!206_arg_0_1 ?z) (tail!942 l!205))) )))))) )))
(check-sat)
(exit)
