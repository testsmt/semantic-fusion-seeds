...
(assert (not (forall ((x!228 (_ BitVec 32))) (or (= (bvand x!228 (turnOffRightmostOneRec!227 x!228 (_ bv0 32))) (bvadd x!228 (_ bv4294967295 32))) (forall ((?z I_turnOffRightmostOneRec!227)) (not (and (= (turnOffRightmostOneRec!227_arg_0_1 ?z) x!228) (= (turnOffRightmostOneRec!227_arg_1_2 ?z) (_ bv0 32)))) )) )))
(check-sat)
(exit)
