...
(assert (not (forall ((BOUND_VARIABLE_505 Formula!1288)) (or (and (= (nnf!210 BOUND_VARIABLE_505) BOUND_VARIABLE_505) (not (isNNF!212 BOUND_VARIABLE_505))) (not (isNNF!212 (Not!1297 BOUND_VARIABLE_505))) (= (nnf!210 (Not!1297 BOUND_VARIABLE_505)) (Not!1297 BOUND_VARIABLE_505))) )))
(check-sat)
(exit)
