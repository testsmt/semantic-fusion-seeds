...
(assert (exists ((stat!228 Statement!2232)) (not (=> (and (and (and (and ((_ is IfThenElse!2243) stat!228) ((_ is IfThenElse!2243) stat!228)) (isWhileFree!221 stat!228)) (=> (isWhileFree!221 (then!2245 stat!228)) (= (eliminateWhileLoops!213 (then!2245 stat!228)) (then!2245 stat!228)))) (=> (isWhileFree!221 (elze!2246 stat!228)) (= (eliminateWhileLoops!213 (elze!2246 stat!228)) (elze!2246 stat!228)))) (= (eliminateWhileLoops!213 stat!228) stat!228))) ))
(check-sat)
(exit)
