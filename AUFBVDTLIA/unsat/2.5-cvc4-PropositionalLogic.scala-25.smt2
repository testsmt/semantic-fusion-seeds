...
(assert (exists ((f!221 Formula!1320)) (not (=> (and (and (and (and ((_ is And!1321) f!221) ((_ is And!1321) f!221)) (isSimplified!208 f!221)) (=> (isSimplified!208 (lhs!1322 f!221)) (= (simplify!206 (lhs!1322 f!221)) (lhs!1322 f!221)))) (=> (isSimplified!208 (rhs!1323 f!221)) (= (simplify!206 (rhs!1323 f!221)) (rhs!1323 f!221)))) (= (simplify!206 f!221) f!221))) ))
(check-sat)
(exit)
