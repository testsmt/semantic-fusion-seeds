...
(assert (exists ((x!422 Nat!2151) (xs!423 Lst!2155) (ys!424 Lst!2155)) (not (= (zip!288 (cons!2156 x!422 xs!423) ys!424) (ite (= ys!424 nil!2159) znil!2164 (zcons!2161 (mkpair!2166 x!422 (head!209 ys!424)) (zip!288 xs!423 (tail!211 ys!424)))))) ))
(check-sat)
(exit)
