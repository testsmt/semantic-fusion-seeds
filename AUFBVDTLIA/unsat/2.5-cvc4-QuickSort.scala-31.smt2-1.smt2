...
(assert (not (forall ((e!255 (_ BitVec 32)) (BOUND_VARIABLE_369 (_ BitVec 32)) (BOUND_VARIABLE_370 List!1259)) (or (not (contains!209 (equals!239 e!255 BOUND_VARIABLE_370) e!255)) (contains!209 (equals!239 e!255 (Cons!1260 BOUND_VARIABLE_369 BOUND_VARIABLE_370)) e!255) (not (contains!209 (Cons!1260 BOUND_VARIABLE_369 BOUND_VARIABLE_370) e!255))) )))
(check-sat)
(exit)
