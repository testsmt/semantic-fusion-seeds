...
(assert (exists ((l!252 List!1252) (e!251 (_ BitVec 32)) (n!250 (_ BitVec 32))) (not (=> ((_ is Nil!1256) l!252) (or (or (not (and (and (and (contains!209 l!252 e!251) (not (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) l!252) (= (contains!209_arg_1_2 ?z) e!251))) ))) (and (contains!209 l!252 e!251) (not (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) l!252) (= (contains!209_arg_1_2 ?z) e!251))) )))) (bvsgt e!251 n!250))) (not (and (and (and (contains!209 l!252 e!251) (not (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) l!252) (= (contains!209_arg_1_2 ?z) e!251))) ))) (and (contains!209 l!252 e!251) (not (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) l!252) (= (contains!209_arg_1_2 ?z) e!251))) )))) (bvsgt e!251 n!250)))) (or (contains!209 (greater!227 n!250 l!252) e!251) (forall ((?z I_contains!209)) (not (and (= (contains!209_arg_0_1 ?z) (greater!227 n!250 l!252)) (= (contains!209_arg_1_2 ?z) e!251))) ) (forall ((?z I_greater!227)) (not (and (= (greater!227_arg_0_3 ?z) n!250) (= (greater!227_arg_1_4 ?z) l!252))) ))))) ))
(check-sat)
(exit)
