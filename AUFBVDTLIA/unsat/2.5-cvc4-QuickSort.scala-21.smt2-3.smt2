...
(assert (not (forall ((n!240 (_ BitVec 32)) (BOUND_VARIABLE_396 (_ BitVec 32)) (BOUND_VARIABLE_397 List!1153)) (or (ite ((_ is Some!1160) (max!216 (equals!239 n!240 BOUND_VARIABLE_397))) (not ((_ is None!1159) (max!216 (equals!239 n!240 BOUND_VARIABLE_397)))) (ite (= (i!1161 (max!216 (equals!239 n!240 BOUND_VARIABLE_397))) n!240) false (not error_value!1165))) (ite ((_ is Some!1160) (max!216 (equals!239 n!240 (Cons!1154 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) (= (i!1161 (max!216 (equals!239 n!240 (Cons!1154 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) n!240) (ite ((_ is None!1159) (max!216 (equals!239 n!240 (Cons!1154 BOUND_VARIABLE_396 BOUND_VARIABLE_397)))) true error_value!1166))) )))
(check-sat)
(exit)
