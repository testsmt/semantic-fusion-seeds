...
(assert (exists ((f!211 Formula!1093)) (not (=> (and (and (and ((_ is Or!1099) f!211) ((_ is Or!1099) f!211)) (= (eval!210 (lhs!1100 f!211)) (eval!210 (nnf!206 (lhs!1100 f!211))))) (= (eval!210 (rhs!1101 f!211)) (eval!210 (nnf!206 (rhs!1101 f!211))))) (= (eval!210 f!211) (eval!210 (nnf!206 f!211))))) ))
(check-sat)
(exit)
