...
(assert (exists ((f!221 Formula!1384)) (not (=> (and (and (and (and ((_ is Or!1395) f!221) ((_ is Or!1395) f!221)) (isSimplified!208 f!221)) (=> (isSimplified!208 (lhs!1396 f!221)) (= (simplify!206 (lhs!1396 f!221)) (lhs!1396 f!221)))) (=> (isSimplified!208 (rhs!1397 f!221)) (= (simplify!206 (rhs!1397 f!221)) (rhs!1397 f!221)))) (= (simplify!206 f!221) f!221))) ))
(check-sat)
(exit)
