...
(assert (exists ((list!244 List!1192) (n!243 (_ BitVec 32))) (not (=> (and (and ((_ is Cons!1193) list!244) ((_ is Cons!1193) list!244)) (ite ((_ is Some!1199) (min!214 (equals!239 n!243 (tail!1195 list!244)))) (= n!243 (i!1200 (min!214 (equals!239 n!243 (tail!1195 list!244))))) (ite ((_ is None!1198) (min!214 (equals!239 n!243 (tail!1195 list!244)))) true error_value!1204))) (ite ((_ is Some!1199) (min!214 (equals!239 n!243 list!244))) (= n!243 (i!1200 (min!214 (equals!239 n!243 list!244)))) (ite ((_ is None!1198) (min!214 (equals!239 n!243 list!244))) true error_value!1205)))) ))
(check-sat)
(exit)
