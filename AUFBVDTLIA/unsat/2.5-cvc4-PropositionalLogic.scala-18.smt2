...
(assert (exists ((f!217 Formula!1206)) (not (=> (and (and (and ((_ is Not!1215) f!217) ((_ is Not!1215) f!217)) (isNNF!212 f!217)) (=> (isNNF!212 (f!1216 f!217)) (isNNF!212 (simplify!206 (f!1216 f!217))))) (isNNF!212 (simplify!206 f!217)))) ))
(check-sat)
(exit)
