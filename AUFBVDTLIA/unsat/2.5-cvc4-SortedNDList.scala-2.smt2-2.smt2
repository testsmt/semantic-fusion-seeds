...
(assert (not (forall ((node!208 (_ BitVec 32)) (dist!209 (_ BitVec 32))) (or (bvslt dist!209 (_ bv0 32)) (bvslt node!208 (_ bv0 32)) (not (sndInvariant!206 ListEnd!890)) (sndInvariant!206 (ListNode!891 dist!209 node!208 ListEnd!890))) )))
(check-sat)
(exit)
