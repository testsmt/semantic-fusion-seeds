...
(assert (not (forall ((n!217 (_ BitVec 32)) (x!216 (_ BitVec 32))) (or (not (bvslt n!217 (_ bv32 32))) (not (= (isBitNSet!213 (bvor x!216 (bvshl (_ bv1 32) n!217)) n!217) (_ bv0 32))) (bvslt n!217 (_ bv0 32))) )))
(check-sat)
(exit)
