...
(assert (exists ((list!207 SortedNDList!889) (node!208 (_ BitVec 32)) (dist!209 (_ BitVec 32))) (not (=> (and (and (and (and ((_ is ListEnd!890) list!207) ((_ is ListEnd!890) list!207)) (sndInvariant!206 list!207)) (bvsge node!208 (_ bv0 32))) (bvsge dist!209 (_ bv0 32))) (sndInvariant!206 (ListNode!891 node!208 dist!209 list!207)))) ))
(check-sat)
(exit)
