...
(assert (exists ((f!219 Formula!1256)) (not (=> (and (and (and (and ((_ is Implies!1260) f!219) ((_ is Implies!1260) f!219)) (isNNF!212 f!219)) (=> (isNNF!212 (lhs!1261 f!219)) (= (nnf!210 (lhs!1261 f!219)) (lhs!1261 f!219)))) (=> (isNNF!212 (rhs!1262 f!219)) (= (nnf!210 (rhs!1262 f!219)) (rhs!1262 f!219)))) (= (nnf!210 f!219) f!219))) ))
(check-sat)
(exit)
