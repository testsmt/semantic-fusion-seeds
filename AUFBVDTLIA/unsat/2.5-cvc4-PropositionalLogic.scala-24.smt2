...
(assert (exists ((f!219 Formula!1304)) (not (=> (and (and (and (and ((_ is Or!1315) f!219) ((_ is Or!1315) f!219)) (isNNF!212 f!219)) (=> (isNNF!212 (lhs!1316 f!219)) (= (nnf!210 (lhs!1316 f!219)) (lhs!1316 f!219)))) (=> (isNNF!212 (rhs!1317 f!219)) (= (nnf!210 (rhs!1317 f!219)) (rhs!1317 f!219)))) (= (nnf!210 f!219) f!219))) ))
(check-sat)
(exit)
