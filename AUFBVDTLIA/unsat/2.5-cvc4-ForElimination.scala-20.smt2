...
(assert (exists ((stat!228 Statement!2300)) (not (=> (and (and ((_ is Print!2315) stat!228) ((_ is Print!2315) stat!228)) (isWhileFree!221 stat!228)) (= (eliminateWhileLoops!213 stat!228) stat!228))) ))
(check-sat)
(exit)
