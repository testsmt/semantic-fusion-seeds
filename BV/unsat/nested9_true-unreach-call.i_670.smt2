...
(assert
 (not
 (and (bvsle (_ bv3 32) c_main_~i~6) (bvsle (_ bv2 32) c_main_~i~6) 
 (bvsle (_ bv1 32) c_main_~i~6) (bvsle (_ bv0 32) c_main_~i~6) 
 (bvsle (bvmul (_ bv2 32) c_main_~i~6) c_main_~j~6)
 (exists ((v_nnf_40 (_ BitVec 32)))
  (and (bvsle c_main_~k~6 (bvadd v_nnf_40 (_ bv2 32))) 
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_40) (_ bv1 32)) c_main_~j~6) 
  (bvsle (_ bv3 32) v_nnf_40))))))
(check-sat)
(exit)
