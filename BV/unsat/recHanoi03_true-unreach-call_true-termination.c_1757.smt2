...
(assert
 (exists ((v_nnf_151 (_ BitVec 32)) (v_nnf_152 (_ BitVec 32)))
  (and (bvsle c_hanoi_~n (_ bv4 32)) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_151) (_ bv1 32)) |c_hanoi_#t~ret0|)
  (bvsle (_ bv1 32) v_nnf_152) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_152) (_ bv1 32)) v_nnf_151)
  (bvsle |c_hanoi_#in~n| c_hanoi_~n))))
(assert
 (not
 (exists ((v_nnf_154 (_ BitVec 32)) (v_nnf_153 (_ BitVec 32)))
  (and (bvsle |c_hanoi_#in~n| (_ bv4 32)) 
  (bvsle (_ bv1 32) v_nnf_154) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_153) (_ bv1 32)) |c_hanoi_#t~ret0|)
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_154) (_ bv1 32)) v_nnf_153)))))
(check-sat)
(exit)
