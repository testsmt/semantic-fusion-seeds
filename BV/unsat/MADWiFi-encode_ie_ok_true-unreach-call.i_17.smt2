...
(declare-fun c_main_~p~6 () (_ BitVec 32))
(declare-fun c_main_~i~6 () (_ BitVec 32))
(declare-fun c_main_~bufsize_0~6 () (_ BitVec 32))
(declare-fun c_main_~ielen~6 () (_ BitVec 32))
(assert
 (and (bvslt c_main_~i~6 c_main_~ielen~6) 
 (bvsle (_ bv5 32) c_main_~i~6)
 (bvsle (bvadd (bvmul (_ bv2 32) c_main_~ielen~6) c_main_~p~6) (bvadd c_main_~bufsize_0~6 (_ bv10 32)))))
(assert
 (not
 (and (bvsle (_ bv5 32) c_main_~i~6)
 (bvsle (bvadd (bvmul (_ bv2 32) c_main_~ielen~6) c_main_~p~6) (bvadd c_main_~bufsize_0~6 (_ bv10 32)))
 (bvsle (_ bv4 32) c_main_~i~6)
 (exists ((main_~ielen~6 (_ BitVec 32)))
  (and (bvsle (_ bv6 32) main_~ielen~6)
  (bvsle (bvadd (bvmul (_ bv2 32) main_~ielen~6) c_main_~p~6) (bvadd c_main_~bufsize_0~6 (_ bv10 32))))))))
(check-sat)
(exit)
