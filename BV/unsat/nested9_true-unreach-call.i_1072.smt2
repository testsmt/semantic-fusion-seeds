...
(assert
 (and (bvsle (_ bv1 32) c_main_~i~6)
 (exists ((v_nnf_72 (_ BitVec 32)))
  (and (bvsle c_main_~k~6 (bvadd v_nnf_72 (_ bv2 32))) 
  (bvsle (_ bv4 32) v_nnf_72) (bvsle (bvmul (_ bv2 32) v_nnf_72) c_main_~j~6))) 
 (bvsle (_ bv0 32) c_main_~i~6) (bvsle (_ bv3 32) c_main_~i~6) 
 (bvsle (_ bv2 32) c_main_~i~6)))
(assert
 (not
 (and (bvsle (_ bv1 32) c_main_~i~6) (bvsle (_ bv0 32) c_main_~i~6)
 (exists ((v_nnf_74 (_ BitVec 32)))
  (and (bvsle c_main_~k~6 (bvadd v_nnf_74 (_ bv3 32))) 
  (bvsle (bvmul (_ bv2 32) v_nnf_74) c_main_~j~6) 
  (bvsle (_ bv4 32) v_nnf_74))) (bvsle (_ bv3 32) c_main_~i~6) 
 (bvsle (_ bv2 32) c_main_~i~6))))
(check-sat)
(exit)
