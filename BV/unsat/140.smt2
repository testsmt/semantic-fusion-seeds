...
(assert
 ...
 (($x817
   (forall
    ...
    (let (($x850 (= ?x849 V3_0)))
    (let ((?x919 (bvadd (bvneg (_ bv1 32)) V2_0)))
    (let ((?x920 (ite MW_S1_V1 S1_V1_!69 E1_!68)))
    (let (($x889 (= ?x920 ?x919)))
    (let (($x583 (and $x889 $x850 $x848 $x762)))
    (let (($x854 (bvsle E1_!74 ?x919)))
    (let (($x737 (not $x854)))
    (let (($x769 (bvsle V2_0 E1_!73)))
    (let (($x839 (not $x769)))
    (let ((?x841 (bvadd (bvneg (_ bv1 32)) ?x846)))
    (let (($x842 (bvsge ?x920 ?x841)))
    (let (($x843 (bvsle V2_0 E1_!68)))
    (let (($x847 (not $x843)))
