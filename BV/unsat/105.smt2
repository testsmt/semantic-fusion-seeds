 ...
 (($x62430
   (forall
    ((V1_0 (_ BitVec 32)) (V3_0 (_ BitVec 32)) 
     ...
     (MW_S1_V6 Bool) (E1_!4904 (_ BitVec 32)) 
     (E1_!4907 (_ BitVec 32)) (E1_!4909 (_ BitVec 32)) 
     (E2_!4905 (_ BitVec 32)) (E2_!4906 (_ BitVec 32)) 
     (E2_!4908 (_ BitVec 32)))
    (let
    (($x60277
      (and (not (bvsle V4_0 E2_!4905)) 
      (not (bvsle V2_0 E1_!4904)) 
      (bvsge E2_!4906 V4_0) (bvsge E1_!4904 (bvadd (bvneg (_ bv1 32)) V2_0))
      (not (bvsle V2_0 E1_!4907)) 
      (not (bvsle V4_0 E2_!4908)) 
      (bvsge E1_!4909 V2_0) (bvsge E2_!4908 (bvadd (bvneg (_ bv1 32)) V4_0)))))
    (let
    (($x61317
    ...
    (and (= E1_!4904 (bvadd (bvneg (_ bv1 32)) E1_!4909)) (= E2_!4906 (bvadd (_ bv1 32) E2_!4908))))))))))))
 (let
 (($x69
...
(assert (not (and (not R_E1_V1) (not R_E1_V3))))
(assert R_E2_V3)
(check-sat)
(exit)
