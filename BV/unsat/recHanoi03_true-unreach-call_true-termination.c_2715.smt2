...
(assert
 (exists ((v_nnf_229 (_ BitVec 32)) (v_nnf_228 (_ BitVec 32)))
  (and (bvsle c_hanoi_~n (_ bv4 32)) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_229) (_ bv1 32)) |c_hanoi_#t~ret0|)
  (bvsle |c_hanoi_#in~n| c_hanoi_~n) 
  (bvsle (_ bv1 32) v_nnf_228) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_228) (_ bv1 32)) v_nnf_229))))
(assert
 (not
 (exists ((v_nnf_231 (_ BitVec 32)) (v_nnf_230 (_ BitVec 32)))
  (and (bvsle |c_hanoi_#in~n| (_ bv4 32)) 
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_231) (_ bv1 32)) v_nnf_230)
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_230) (_ bv1 32)) |c_hanoi_#t~ret0|) 
  (bvsle (_ bv1 32) v_nnf_231)))))
(check-sat)
(exit)
