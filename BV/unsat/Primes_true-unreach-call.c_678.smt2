...
(declare-fun |main_#t~ret12_0| () (_ BitVec 32))
(declare-fun main_~f1~22_0 () (_ BitVec 32))
(declare-fun main_~n~22_0 () (_ BitVec 32))
(declare-fun |main_#t~short13_1| () Bool)
(assert
 (and
 (let
 ((|main_#t~ret12| |main_#t~ret12_0|)
  (main_~f1~22 main_~f1~22_0)
  (main_~n~22 main_~n~22_0))
 (and
 (exists ((v_nnf_35 (_ BitVec 32)) (v_nnf_34 (_ BitVec 32)))
  (and (bvsle (bvadd main_~f1~22 (bvmul (_ bv2 32) v_nnf_35) (bvmul (_ bv2 32) v_nnf_34) (_ bv1 32)) |main_#t~ret12|)
  (bvsle main_~f1~22 v_nnf_35) 
  (bvsle v_nnf_35 v_nnf_34) (bvsle main_~n~22 (_ bv2 32)))) 
 (bvsle main_~n~22 (_ bv2 32))))
 (let ((|v_main_#t~short13_7| |main_#t~short13_1|))
 (let ((v_main_~n~22_5 main_~n~22_0))
 (let ((|v_main_#t~ret12_4| |main_#t~ret12_0|))
 (= |v_main_#t~short13_7| (= |v_main_#t~ret12_4| v_main_~n~22_5)))))
 (not
 (let
 ((|main_#t~ret12| |main_#t~ret12_0|)
  (main_~f1~22 main_~f1~22_0)
