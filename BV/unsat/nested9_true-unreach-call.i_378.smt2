...
(assert
 ...
 (exists ((v_nnf_22 (_ BitVec 32)))
  (and (bvsle (bvadd v_nnf_22 (_ bv2 32)) c_main_~k~6) 
  (bvsle c_main_~j~6 (bvmul (_ bv2 32) v_nnf_22)) 
  (bvsle v_nnf_22 (_ bv3 32)))) (bvsle c_main_~j~6 (bvmul (_ bv2 32) c_main_~i~6)) 
