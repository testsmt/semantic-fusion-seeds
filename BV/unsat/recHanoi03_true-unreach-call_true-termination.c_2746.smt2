...
(assert
 (exists ((v_nnf_236 (_ BitVec 32)) (v_nnf_235 (_ BitVec 32)) (v_nnf_234 (_ BitVec 32)))
  (and (bvsle c_hanoi_~n (_ bv5 32)) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_235) (_ bv1 32)) |c_hanoi_#t~ret0|)
  (bvsle (_ bv1 32) v_nnf_236) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_236) (_ bv1 32)) v_nnf_234)
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_234) (_ bv1 32)) v_nnf_235) 
  (bvsle |c_hanoi_#in~n| c_hanoi_~n))))
(assert
 (not
 (exists ((v_nnf_239 (_ BitVec 32)) (v_nnf_238 (_ BitVec 32)) (v_nnf_237 (_ BitVec 32)))
  (and (bvsle |c_hanoi_#in~n| (_ bv5 32)) 
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_239) (_ bv1 32)) v_nnf_238) 
  (bvsle (_ bv1 32) v_nnf_237) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_237) (_ bv1 32)) v_nnf_239)
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_238) (_ bv1 32)) |c_hanoi_#t~ret0|)))))
(check-sat)
(exit)
