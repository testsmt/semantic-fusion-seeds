...
(assert
 ...
 (exists ((|v_hanoi_#t~ret0_15| (_ BitVec 32)))
  (and (bvsle (_ bv1 32) |v_hanoi_#t~ret0_15|) 
  (bvsle |c_hanoi_#in~n| (_ bv2 32))
  (bvsle (bvadd (bvmul (_ bv2 32) |v_hanoi_#t~ret0_15|) (_ bv1 32)) |c_hanoi_#res|)))))
(assert
 (not
 (exists ((|v_hanoi_#t~ret0_15| (_ BitVec 32)))
  (and (bvsle (_ bv1 32) |v_hanoi_#t~ret0_15|) 
