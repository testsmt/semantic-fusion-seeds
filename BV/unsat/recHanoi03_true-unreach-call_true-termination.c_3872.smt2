...
(assert
 (exists ((v_nnf_325 (_ BitVec 32)))
  (and (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_325) (_ bv1 32)) |c_hanoi_#t~ret0|) 
  (bvsle c_hanoi_~n (_ bv3 32)) (bvsle |c_hanoi_#in~n| c_hanoi_~n) 
  (bvsle (_ bv1 32) v_nnf_325))))
(assert
 (not
 (exists ((v_nnf_326 (_ BitVec 32)))
  (and (bvsle |c_hanoi_#in~n| (_ bv3 32)) 
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_326) (_ bv1 32)) |c_hanoi_#t~ret0|) 
  (bvsle (_ bv1 32) v_nnf_326)))))
(check-sat)
(exit)
