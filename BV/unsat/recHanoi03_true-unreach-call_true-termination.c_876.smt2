...
(assert
 (exists ((v_nnf_51 (_ BitVec 32)))
  (and (bvsle c_hanoi_~n (_ bv3 32)) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_51) (_ bv1 32)) |c_hanoi_#t~ret0|)
  (bvsle (_ bv1 32) v_nnf_51) (bvsle |c_hanoi_#in~n| c_hanoi_~n))))
(assert
 (not
 (and (bvsle |c_hanoi_#in~n| c_hanoi_~n)
 (exists ((v_nnf_52 (_ BitVec 32)))
  (and (bvsle |c_hanoi_#in~n| (_ bv3 32)) 
  (bvsle (_ bv1 32) v_nnf_52) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_52) (_ bv1 32)) |c_hanoi_#t~ret0|))))))
(check-sat)
(exit)
