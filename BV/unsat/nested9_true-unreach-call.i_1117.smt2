...
(assert
 (and (bvsle c_main_~i~6 (_ bv2 32)) (bvsle c_main_~j~6 (bvmul (_ bv2 32) c_main_~i~6))
 (bvsle c_main_~i~6 (_ bv4 32)) (bvsle c_main_~i~6 (_ bv3 32))
 (exists ((v_nnf_78 (_ BitVec 32)))
  (and (bvsle (bvadd v_nnf_78 (_ bv2 32)) c_main_~k~6) 
  (bvsle c_main_~j~6 (bvadd (bvmul (_ bv2 32) v_nnf_78) (_ bv1 32))) 
  (bvsle v_nnf_78 (_ bv4 32))))))
(assert
 (not
 ...
 (exists ((main_~i~6 (_ BitVec 32)))
  (and (bvsle c_main_~j~6 (bvadd (bvmul (_ bv2 32) main_~i~6) (_ bv1 32))) 
