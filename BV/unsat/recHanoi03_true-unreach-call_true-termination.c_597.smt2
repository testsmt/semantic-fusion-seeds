...
(declare-fun |c_hanoi_#in~n| () (_ BitVec 32))
(declare-fun |c_hanoi_#t~ret0| () (_ BitVec 32))
(declare-fun c_hanoi_~n () (_ BitVec 32))
(assert
 (exists ((v_nnf_35 (_ BitVec 32)) (v_nnf_36 (_ BitVec 32)) (v_nnf_34 (_ BitVec 32)))
  (and (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_34) (_ bv1 32)) |c_hanoi_#t~ret0|) 
  (bvsle c_hanoi_~n (_ bv5 32)) (bvsle (_ bv1 32) v_nnf_35) 
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_35) (_ bv1 32)) v_nnf_36) 
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_36) (_ bv1 32)) v_nnf_34) 
  (bvsle |c_hanoi_#in~n| c_hanoi_~n))))
(assert
 (not
 (and (bvsle |c_hanoi_#in~n| c_hanoi_~n)
 (exists ((v_nnf_39 (_ BitVec 32)) (v_nnf_37 (_ BitVec 32)) (v_nnf_38 (_ BitVec 32)))
  (and (bvsle |c_hanoi_#in~n| (_ bv5 32)) 
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_38) (_ bv1 32)) v_nnf_39)
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_39) (_ bv1 32)) |c_hanoi_#t~ret0|)
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_37) (_ bv1 32)) v_nnf_38) 
  (bvsle (_ bv1 32) v_nnf_37))))))
(check-sat)
(exit)
