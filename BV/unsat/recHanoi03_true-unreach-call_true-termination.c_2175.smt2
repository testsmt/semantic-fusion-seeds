...
(assert
 (and
 (exists ((|v_hanoi_#t~ret0_27| (_ BitVec 32)) (v_nnf_150 (_ BitVec 32)))
  (and (bvsle (_ bv1 32) v_nnf_150) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_150) (_ bv1 32)) |v_hanoi_#t~ret0_27|)
  (bvsle |c_hanoi_#in~n| (_ bv3 32))
  (bvsle (bvadd (bvmul (_ bv2 32) |v_hanoi_#t~ret0_27|) (_ bv1 32)) |c_hanoi_#res|)))
