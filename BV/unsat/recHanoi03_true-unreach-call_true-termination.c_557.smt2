...
(assert
 (and
 (exists ((|v_hanoi_#t~ret0_13| (_ BitVec 32)) (v_nnf_32 (_ BitVec 32)) (v_nnf_33 (_ BitVec 32)))
  (and (bvsle |c_hanoi_#in~n| (_ bv4 32)) 
  (bvsle (_ bv1 32) v_nnf_32) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_32) (_ bv1 32)) v_nnf_33)
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_33) (_ bv1 32)) |v_hanoi_#t~ret0_13|)
  (bvsle (bvadd (bvmul (_ bv2 32) |v_hanoi_#t~ret0_13|) (_ bv1 32)) |c_hanoi_#res|)))
