...
(assert
 ...
 (exists ((v_nnf_35 (_ BitVec 32)) (v_nnf_34 (_ BitVec 32)))
  (and
  (bvsle (bvadd c_main_~f1~22 (bvmul (_ bv2 32) v_nnf_35) (bvmul (_ bv2 32) v_nnf_34) (_ bv1 32)) |c_main_#t~ret12|)
  (bvsle c_main_~f1~22 v_nnf_35) 
  (bvsle v_nnf_35 v_nnf_34) (bvsle c_main_~n~22 (_ bv2 32))))))
(assert
 (not
 (and
 (exists ((v_nnf_35 (_ BitVec 32)) (v_nnf_34 (_ BitVec 32)))
