...
(assert
 ...
 (($x21121
   (forall
    ...
    (let ((?x21198 (bvadd (bvneg (_ bv1 32)) ?x21188)))
    (let ((?x21052 (ite MW_S1_V3 S1_V3_!1741 (_ bv0 32))))
    (let (($x21202 (= ?x21052 ?x21198)))
    (let ((?x21060 (ite MW_S1_V1 S1_V1_!1740 (_ bv0 32))))
    (let (($x21200 (= ?x21060 ?x21198)))
    (let (($x21220 (and $x21200 $x21202 $x21204 $x21210 $x21216)))
    (let ((?x21190 (bvmul ?x21188 ?x21188)))
    (let (($x21192 (bvsge (_ bv1 32) ?x21190)))
    (let ((?x21182 (bvmul V2_0 V2_0)))
    (let (($x21184 (bvsle ?x21182 (_ bv0 32))))
    (let (($x21186 (not $x21184)))
    (let ((?x21176 (bvadd (bvneg (_ bv1 32)) ?x21174)))
    (let (($x21180 (bvsge ?x21060 ?x21176)))
    (let (($x21178 (bvsge ?x21052 ?x21176)))
    (let (($x21170 (bvsle V2_0 (_ bv0 32))))
    ...
    (let (($x94 (not R_S1_V3)))
    (let (($x21141 (or $x94 (= (bvmul (bvsdiv (_ bv0 32) V2_0) V2_0) (_ bv0 32)))))
    (let ((?x21136 (bvsdiv (_ bv0 32) V2_0)))
    (let (($x21137 (= ?x21136 (_ bv0 32))))
    (let (($x92 (not R_S1_V1)))
    ...
    (($x20975
      ...
      (or (not (and (or $x92 (= (_ bv0 32) ?x21136)) $x21141))
