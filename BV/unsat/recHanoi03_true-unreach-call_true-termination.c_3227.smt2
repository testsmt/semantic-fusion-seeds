...
(assert
 (and
 (exists ((v_nnf_227 (_ BitVec 32)) (|v_hanoi_#t~ret0_34| (_ BitVec 32)))
  (and (bvsle (bvadd (bvmul (_ bv2 32) |v_hanoi_#t~ret0_34|) (_ bv1 32)) |c_hanoi_#res|) 
  (bvsle (_ bv1 32) v_nnf_227) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_227) (_ bv1 32)) |v_hanoi_#t~ret0_34|)
  (bvsle |c_hanoi_#in~n| (_ bv3 32)))) 
