...
(assert
 (and (= |c_main_#t~short13| (= |c_main_#t~ret12| c_main_~n~22))
 (exists ((v_nnf_60 (_ BitVec 32)) (v_nnf_58 (_ BitVec 32)) (v_nnf_59 (_ BitVec 32)))
  (and
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_60) (bvmul (_ bv2 32) v_nnf_58) (bvmul (_ bv2 32) v_nnf_59) (_ bv1 32)) |c_main_#t~ret12|)
  (bvsle c_main_~f1~22 v_nnf_58) 
  (bvsle v_nnf_58 v_nnf_60) (bvsle v_nnf_60 v_nnf_59) 
