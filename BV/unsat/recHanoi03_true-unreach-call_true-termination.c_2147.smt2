...
(assert
 (exists ((v_nnf_148 (_ BitVec 32)))
  (and (bvsle c_hanoi_~n (_ bv3 32)) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_148) (_ bv1 32)) |c_hanoi_#t~ret0|)
  (bvsle |c_hanoi_#in~n| c_hanoi_~n) 
  (bvsle (_ bv1 32) v_nnf_148))))
(assert
 (not
 (and (bvsle |c_hanoi_#in~n| c_hanoi_~n)
 (exists ((v_nnf_149 (_ BitVec 32)))
  (and (bvsle |c_hanoi_#in~n| (_ bv3 32)) 
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_149) (_ bv1 32)) |c_hanoi_#t~ret0|) 
  (bvsle (_ bv1 32) v_nnf_149))))))
(check-sat)
(exit)
