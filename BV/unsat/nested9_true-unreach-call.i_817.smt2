...
(assert
 ...
 (exists ((v_nnf_48 (_ BitVec 32)))
  (and (bvsle (bvadd v_nnf_48 (_ bv3 32)) c_main_~k~6) 
  (bvsle v_nnf_48 (_ bv3 32)) (bvsle c_main_~j~6 (bvadd (bvmul (_ bv2 32) v_nnf_48) (_ bv2 32))))) 
