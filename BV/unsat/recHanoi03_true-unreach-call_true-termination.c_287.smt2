...
(declare-fun |c_hanoi_#res| () (_ BitVec 32))
(declare-fun c_hanoi_~n () (_ BitVec 32))
(assert
 (and (bvsle |c_hanoi_#in~n| c_hanoi_~n)
 (exists ((|v_hanoi_#t~ret0_10| (_ BitVec 32)) (v_nnf_18 (_ BitVec 32)) (v_nnf_17 (_ BitVec 32)))
  (and (bvsle (bvadd (bvmul (_ bv2 32) |v_hanoi_#t~ret0_10|) (_ bv1 32)) |c_hanoi_#res|)
  (bvsle |c_hanoi_#in~n| (_ bv4 32)) (bvsle (_ bv1 32) v_nnf_17) 
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_17) (_ bv1 32)) v_nnf_18)
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_18) (_ bv1 32)) |v_hanoi_#t~ret0_10|)))))
(assert
 (not
 (exists ((|v_hanoi_#t~ret0_10| (_ BitVec 32)) (v_nnf_18 (_ BitVec 32)) (v_nnf_17 (_ BitVec 32)))
  (and (bvsle (bvadd (bvmul (_ bv2 32) |v_hanoi_#t~ret0_10|) (_ bv1 32)) |c_hanoi_#res|)
