...
(assert
 ...
 (exists ((v_nnf_16 (_ BitVec 32)) (v_nnf_17 (_ BitVec 32)))
  (and (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_16) (bvmul (_ bv2 32) v_nnf_17) (_ bv1 32)) |c_main_#t~ret12|)
  (bvsle c_main_~f1~22 v_nnf_16) 
  (bvsle c_main_~n~22 (_ bv2 32)) (bvsle v_nnf_16 v_nnf_17)))))
(assert
 (not
 (exists ((v_nnf_16 (_ BitVec 32)) (v_nnf_17 (_ BitVec 32)))
  (and (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_16) (bvmul (_ bv2 32) v_nnf_17) (_ bv1 32)) |c_main_#t~ret12|)
