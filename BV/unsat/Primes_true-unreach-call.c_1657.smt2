...
(declare-fun |c_main_#t~ret12| () (_ BitVec 32))
(declare-fun c_main_~n~22 () (_ BitVec 32))
(declare-fun c_main_~f1~22 () (_ BitVec 32))
(assert
 (exists ((v_nnf_94 (_ BitVec 32)) (v_nnf_95 (_ BitVec 32)) (v_nnf_96 (_ BitVec 32)))
  (and
  (bvsle (bvadd c_main_~f1~22 (bvmul (_ bv2 32) v_nnf_94) (bvmul (_ bv2 32) v_nnf_95) (bvmul (_ bv2 32) v_nnf_96) (_ bv1 32))
  |c_main_#t~ret12|) (bvsle c_main_~f1~22 v_nnf_94) 
  (bvsle v_nnf_96 v_nnf_95) (bvsle v_nnf_94 v_nnf_96) 
  (bvsle c_main_~n~22 (_ bv2 32)))))
(assert
 (not
 (and
 (exists ((v_nnf_94 (_ BitVec 32)) (v_nnf_95 (_ BitVec 32)) (v_nnf_96 (_ BitVec 32)))
  ...
  |c_main_#t~ret12|) (bvsle c_main_~f1~22 v_nnf_94) 
  (bvsle v_nnf_96 v_nnf_95) (bvsle v_nnf_94 v_nnf_96) 
  (bvsle c_main_~n~22 (_ bv2 32)))) (bvsle c_main_~n~22 (_ bv2 32)))))
(check-sat)
(exit)
