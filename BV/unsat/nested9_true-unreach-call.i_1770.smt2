...
(assert
 ...
 (exists ((v_nnf_98 (_ BitVec 32)))
  (and (bvsle (bvadd v_nnf_98 (_ bv3 32)) c_main_~k~6) 
  (bvsle v_nnf_98 (_ bv4 32)) (bvsle c_main_~j~6 (bvadd (bvmul (_ bv2 32) v_nnf_98) (_ bv2 32)))))))
(assert
 (not
 (and (bvsle c_main_~j~6 (bvadd (bvmul (_ bv2 32) c_main_~i~6) (_ bv1 32))) 
