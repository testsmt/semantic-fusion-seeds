...
(assert
 ...
 (bvsle (_ bv4 32) c_main_~i~6) (bvsle (bvmul (_ bv2 32) c_main_~i~6) c_main_~j~6) 
 (bvsle (_ bv2 32) c_main_~i~6) (bvsle (_ bv0 32) c_main_~i~6)
 (exists ((v_nnf_86 (_ BitVec 32)))
  (and (bvsle c_main_~k~6 (bvadd v_nnf_86 (_ bv1 32))) 
  (bvsle (_ bv4 32) v_nnf_86) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_86) (_ bv1 32)) c_main_~j~6))) 
 (bvsle (_ bv1 32) c_main_~i~6)))
(assert
 (not
 (and (bvsle (_ bv3 32) c_main_~i~6) (bvsle (bvadd (bvmul (_ bv2 32) c_main_~i~6) (_ bv1 32)) c_main_~j~6)
 (bvsle (_ bv4 32) c_main_~i~6) (bvsle (bvmul (_ bv2 32) c_main_~i~6) c_main_~j~6) 
 (bvsle (_ bv2 32) c_main_~i~6) (bvsle (_ bv0 32) c_main_~i~6) 
 (bvsle (_ bv1 32) c_main_~i~6)
 (exists ((v_nnf_88 (_ BitVec 32)))
  (and (bvsle c_main_~k~6 (bvadd v_nnf_88 (_ bv2 32))) 
  (bvsle (_ bv4 32) v_nnf_88) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_88) (_ bv1 32)) c_main_~j~6))))))
(check-sat)
(exit)
