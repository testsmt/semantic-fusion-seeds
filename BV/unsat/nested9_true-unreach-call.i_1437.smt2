...
(assert
 ...
 (exists ((v_nnf_82 (_ BitVec 32)))
  (and (bvsle (bvadd v_nnf_82 (_ bv4 32)) c_main_~k~6) 
  (bvsle c_main_~j~6 (bvadd (bvmul (_ bv2 32) v_nnf_82) (_ bv1 32))) 
  (bvsle v_nnf_82 (_ bv4 32))))))
(assert
 (not
 (and (bvsle c_main_~j~6 (bvadd (bvmul (_ bv2 32) c_main_~i~6) (_ bv1 32))) 
