...
(assert
 (and (bvsle (_ bv0 32) c_main_~i~6) (bvsle (_ bv1 32) c_main_~i~6) 
 (bvsle (_ bv3 32) c_main_~i~6) (bvsle (_ bv2 32) c_main_~i~6)
 (exists ((v_nnf_26 (_ BitVec 32)))
  (and (bvsle c_main_~k~6 (bvadd v_nnf_26 (_ bv1 32))) 
  (bvsle (_ bv3 32) v_nnf_26) (bvsle (bvmul (_ bv2 32) v_nnf_26) c_main_~j~6)))
