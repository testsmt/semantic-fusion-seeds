...
(assert
 ...
 (exists ((v_nnf_6 (_ BitVec 32)))
  (and (bvsle (bvadd v_nnf_6 (_ bv2 32)) c_main_~k~6) 
  (bvsle v_nnf_6 (_ bv2 32)) (bvsle c_main_~j~6 (bvmul (_ bv2 32) v_nnf_6))))))
(assert
 (not
 (and (bvsle c_main_~j~6 (bvmul (_ bv2 32) c_main_~i~6)) 
 (bvsle c_main_~i~6 (_ bv2 32))
 (exists ((v_nnf_4 (_ BitVec 32)))
  (and (bvsle (bvadd v_nnf_4 (_ bv1 32)) c_main_~k~6) 
  (bvsle c_main_~j~6 (bvmul (_ bv2 32) v_nnf_4)) 
  (bvsle v_nnf_4 (_ bv2 32)))))))
(check-sat)
(exit)
