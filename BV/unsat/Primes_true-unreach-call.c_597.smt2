...
(declare-fun |c_mult_#t~ret1| () (_ BitVec 32))
(declare-fun c_mult_~n () (_ BitVec 32))
(assert
 (and (bvsle |c_mult_#in~n| c_mult_~n)
 (exists ((v_nnf_29 (_ BitVec 32)) (v_nnf_28 (_ BitVec 32)))
  (and (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_29) (bvmul (_ bv2 32) v_nnf_28) (_ bv1 32)) |c_mult_#t~ret1|)
  (bvsle c_mult_~n v_nnf_29) 
  (bvsle v_nnf_29 v_nnf_28) (bvsle |c_mult_#in~n| c_mult_~n)))))
(assert
 (not
 (exists ((v_nnf_29 (_ BitVec 32)) (v_nnf_28 (_ BitVec 32)))
  (and (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_29) (bvmul (_ bv2 32) v_nnf_28) (_ bv1 32)) |c_mult_#t~ret1|)
