...
(assert
 (exists ((v_nnf_94 (_ BitVec 32)) (v_nnf_95 (_ BitVec 32)))
  (and (bvsle c_hanoi_~n (_ bv4 32)) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_94) (_ bv1 32)) |c_hanoi_#t~ret0|)
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_95) (_ bv1 32)) v_nnf_94) 
  (bvsle (_ bv1 32) v_nnf_95) (bvsle |c_hanoi_#in~n| c_hanoi_~n))))
(assert
 (not
 (and (bvsle |c_hanoi_#in~n| c_hanoi_~n)
 (exists ((v_nnf_97 (_ BitVec 32)) (v_nnf_96 (_ BitVec 32)))
  (and (bvsle |c_hanoi_#in~n| (_ bv4 32)) 
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_96) (_ bv1 32)) |c_hanoi_#t~ret0|)
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_97) (_ bv1 32)) v_nnf_96) 
  (bvsle (_ bv1 32) v_nnf_97))))))
(check-sat)
(exit)
