...
(assert
 (exists ((v_nnf_14 (_ BitVec 32)) (v_nnf_13 (_ BitVec 32)))
  (and (bvsle c_hanoi_~n (_ bv4 32)) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_14) (_ bv1 32)) |c_hanoi_#t~ret0|)
  (bvsle (_ bv1 32) v_nnf_13) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_13) (_ bv1 32)) v_nnf_14)
  (bvsle |c_hanoi_#in~n| c_hanoi_~n))))
(assert
 (not
 (and (bvsle |c_hanoi_#in~n| c_hanoi_~n)
 (exists ((v_nnf_16 (_ BitVec 32)) (v_nnf_15 (_ BitVec 32)))
  (and (bvsle |c_hanoi_#in~n| (_ bv4 32)) 
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_16) (_ bv1 32)) v_nnf_15) 
  (bvsle (_ bv1 32) v_nnf_16) (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_15) (_ bv1 32)) |c_hanoi_#t~ret0|))))))
(check-sat)
(exit)
