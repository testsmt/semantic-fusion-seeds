...
(assert
 (exists ((v_nnf_31 (_ BitVec 32)) (v_nnf_30 (_ BitVec 32)))
  (and (bvsle (bvadd c_mult_~n (bvmul (_ bv2 32) v_nnf_31) (bvmul (_ bv2 32) v_nnf_30) (_ bv1 32)) |c_mult_#res|)
  (bvsle c_mult_~n v_nnf_30) 
  (bvsle v_nnf_30 v_nnf_31) (bvsle |c_mult_#in~n| c_mult_~n))))
(assert
 (not
 (and (bvsle |c_mult_#in~n| c_mult_~n)
 (exists ((v_nnf_32 (_ BitVec 32)) (v_nnf_33 (_ BitVec 32)))
  (and (bvsle |c_mult_#in~n| v_nnf_33)
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_32) (bvmul (_ bv2 32) v_nnf_33) |c_mult_#in~n| (_ bv1 32)) |c_mult_#res|)
  (bvsle v_nnf_33 v_nnf_32))))))
(check-sat)
(exit)
