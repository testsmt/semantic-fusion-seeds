...
(assert
 ...
 (($x71117
   (forall
    ((V8_0 (_ BitVec 32)) (V1_0 (_ BitVec 32)) 
     (V2_0 (_ BitVec 32)) (V4_0 (_ BitVec 32)) 
     (V7_0 (_ BitVec 32)) (MW_S1_V8 Bool) 
     (MW_S1_V1 Bool) (MW_S1_V3 Bool) 
     (MW_S1_V2 Bool) (MW_S1_V4 Bool) 
     (MW_S1_V7 Bool) (S1_V1_!5808 (_ BitVec 32)) 
     (S1_V1_!5815 (_ BitVec 32)) (S1_V3_!5809 (_ BitVec 32)) 
     (S1_V3_!5816 (_ BitVec 32)) (S1_V2_!5810 (_ BitVec 32)) 
     (S1_V2_!5817 (_ BitVec 32)) (E1_!5806 (_ BitVec 32)) 
     (E1_!5813 (_ BitVec 32)) (S1_V8_!5807 (_ BitVec 32)) 
     (S1_V8_!5814 (_ BitVec 32)) (S1_V4_!5811 (_ BitVec 32)) 
     (S1_V4_!5818 (_ BitVec 32)) (S1_V7_!5812 (_ BitVec 32)) 
     (S1_V7_!5819 (_ BitVec 32)))
    (let
    (($x71050
      (and
      ...
      (bvadd (bvneg (_ bv1 32)) (ite MW_S1_V4 S1_V4_!5818 V4_0)))
    ...
    (($x71146
      ...
      (not (bvsle V4_0 E1_!5806))
      (bvsge (ite MW_S1_V3 S1_V3_!5809 E1_!5806)
      (bvadd (bvneg (_ bv1 32)) (ite MW_S1_V4 S1_V4_!5811 V4_0)))
      (bvsge (ite MW_S1_V1 S1_V1_!5808 V1_0)
      (bvadd (bvneg (_ bv1 32)) (ite MW_S1_V2 S1_V2_!5810 V2_0))) 
      (not (bvsle V4_0 E1_!5813))
      (bvsge E1_!5813 (bvadd (bvneg (_ bv1 32)) (ite MW_S1_V4 S1_V4_!5818 V4_0)))
      (bvsge (ite MW_S1_V1 S1_V1_!5815 V1_0)
      (bvadd (bvneg (_ bv1 32)) (ite MW_S1_V2 S1_V2_!5817 V2_0))))))
    (let
    (($x70763
      (and
