...
(assert
 ...
 (($x731
   (forall
    ...
    (let ((?x1021 (bvadd (bvneg (_ bv1 32)) ?x1045)))
    (let ((?x638 (ite MW_S1_V1 S1_V1_!149 (_ bv0 32))))
    ...
    (let (($x1031 (bvsle ?x1045 (_ bv0 32))))
    (let (($x1032 (not $x1031)))
    (let (($x1043 (bvsle (_ bv3 32) V2_0)))
    (let (($x1044 (not $x1043)))
    (let (($x1042 (bvsge V2_0 (_ bv2 32))))
    (let (($x1041 (bvsge V2_0 (_ bv1 32))))
    (let ((?x1039 (bvadd (bvneg (_ bv1 32)) ?x1038)))
    (let (($x1040 (bvsge ?x638 ?x1039)))
    (let (($x1053 (bvsle V2_0 (_ bv0 32))))
    (let (($x1054 (not $x1053)))
    ...
    (($x1059
      ...
      (or $x82 (= (bvadd ?x1072 (bvmul (bvneg (_ bv1 32)) V2_0)) (bvneg (_ bv1 32))))))))
    ...
    (($x957
      (not
      (and $x1074 $x970 $x951 (or $x82 (= (bvneg (_ bv1 32)) (bvadd ?x1072 (bvmul (bvneg (_ bv1 32)) V2_0))))))))
