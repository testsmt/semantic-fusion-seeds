 ...
 (($x2544
   (forall
    ((V1_0 (_ BitVec 32)) (V2_0 (_ BitVec 32)) 
     ...
     (E1_!336 (_ BitVec 32)) (E1_!337 (_ BitVec 32)) 
     (E1_!338 (_ BitVec 32)))
    (let
    (($x2536
      (and (= E1_!337 E1_!336)
      (or (not (or (not R_E1_V1) (= E1_!337 V1_0))) (= E1_!338 E1_!336))
      (or (not (or (not R_E1_V1) (= E1_!337 V1_0))) (= E1_!338 E1_!337))
    ...
    (or (not $x2536)
    (not (and (bvsge E1_!336 V2_0) (bvsge E1_!337 V2_0) (bvsge E1_!338 V2_0)))
    (= E1_!336 E1_!338))))))
 (let
 (($x116
