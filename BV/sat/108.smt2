 ...
 (($x60903
   (forall
    ((V1_0 (_ BitVec 32)) (V3_0 (_ BitVec 32)) 
     ...
     (S1_V1_!5123 (_ BitVec 32)) (S1_V3_!5124 (_ BitVec 32)) 
     (S1_V2_!5125 (_ BitVec 32)) (E1_!5120 (_ BitVec 32)) 
     (E1_!5129 (_ BitVec 32)) (E1_!5131 (_ BitVec 32)) 
     (S1_V5_!5126 (_ BitVec 32)) (E2_!5121 (_ BitVec 32)) 
     (E2_!5122 (_ BitVec 32)) (E2_!5130 (_ BitVec 32)) 
     (S1_V4_!5127 (_ BitVec 32)) (S1_V6_!5128 (_ BitVec 32)))
    (let
    (($x61267
      (and (= (ite MW_S1_V1 S1_V1_!5123 E1_!5120) (bvadd (bvneg (_ bv1 32)) E1_!5131))
    ...
    (let
    (($x62544
      (and (not (bvsle V4_0 E2_!5121)) 
      (not (bvsle V2_0 E1_!5120)) 
      (not (bvsle V4_0 E2_!5122))
      (bvsge (ite MW_S1_V3 S1_V3_!5124 E2_!5122)
      (bvadd (bvneg (_ bv1 32)) (ite MW_S1_V4 S1_V4_!5127 V4_0)))
      (bvsge (ite MW_S1_V1 S1_V1_!5123 E1_!5120)
      (bvadd (bvneg (_ bv1 32)) (ite MW_S1_V2 S1_V2_!5125 V2_0))) 
      (not (bvsle V2_0 E1_!5129)) 
      (not (bvsle V4_0 E2_!5130)) 
      (bvsge E1_!5131 V2_0) (bvsge E2_!5130 (bvadd (bvneg (_ bv1 32)) V4_0)))))
    (let
    (($x60161
