 ...
 (($x1925
   (forall
    ((V1_0 (_ BitVec 32)) (V3_0 (_ BitVec 32)) 
     ...
     (S1_V3_!507 (_ BitVec 32)) (S1_V3_!511 (_ BitVec 32)) 
     (S1_V3_!515 (_ BitVec 32)) (S1_V4_!509 (_ BitVec 32)) 
     (S1_V4_!513 (_ BitVec 32)) (S1_V4_!517 (_ BitVec 32)) 
     (S1_V1_!506 (_ BitVec 32)) (S1_V1_!510 (_ BitVec 32)) 
     (S1_V1_!514 (_ BitVec 32)) (S1_V2_!508 (_ BitVec 32)) 
     (S1_V2_!512 (_ BitVec 32)) (S1_V2_!516 (_ BitVec 32)))
    (let
    ((?x1495 (ite MW_S1_V1 S1_V1_!514 (bvadd (_ bv1 32) (ite MW_S1_V1 S1_V1_!510 V1_0)))))
    (let
    (($x2661
    ...
    (($x1493
      ...
      (bvsge (ite MW_S1_V1 S1_V1_!506 V1_0)
      (bvadd (bvneg (_ bv1 32)) (ite MW_S1_V2 S1_V2_!508 V2_0))) 
      (not (bvsle V2_0 (bvadd (_ bv1 32) V1_0)))
      (bvsge ?x1495 (bvadd (bvneg (_ bv2 32)) (ite MW_S1_V2 S1_V2_!516 V2_0)))
      (bvsge ?x1495 (bvadd (bvneg (_ bv1 32)) (ite MW_S1_V2 S1_V2_!516 V2_0))))))
    (let
    (($x1867
      (and (or (not R_S1_V1) (= V1_0 (bvadd (_ bv1 32) (ite MW_S1_V1 S1_V1_!510 V1_0))))
    ...
    (($x1401
      (and
      (or (not R_S1_V1) (= (ite MW_S1_V1 S1_V1_!510 V1_0) (bvadd (bvneg (_ bv1 32)) V1_0)))
