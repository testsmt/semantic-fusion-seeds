...
(assert
 (exists ((v_nnf_111 (_ BitVec 32)) (v_nnf_112 (_ BitVec 32)))
  (and (bvsle (bvadd c_mult_~n (bvmul (_ bv2 32) v_nnf_111) (bvmul (_ bv2 32) v_nnf_112) (_ bv1 32)) |c_mult_#res|)
  (bvsle c_mult_~n v_nnf_111) 
  (bvsle v_nnf_111 v_nnf_112) 
  (bvsle |c_mult_#in~n| c_mult_~n))))
(assert
 (not
 (and (bvsle |c_mult_#in~n| c_mult_~n)
 (exists ((v_nnf_114 (_ BitVec 32)) (v_nnf_113 (_ BitVec 32)))
  (and (bvsle |c_mult_#in~n| v_nnf_113)
  (bvsle (bvadd (bvmul (_ bv2 32) v_nnf_114) (bvmul (_ bv2 32) v_nnf_113) |c_mult_#in~n| (_ bv1 32)) |c_mult_#res|)
  (bvsle v_nnf_113 v_nnf_114))))))
(check-sat)
(exit)
