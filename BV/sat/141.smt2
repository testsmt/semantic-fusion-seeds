 ...
 (($x1171
   (forall
    ...
    (($x804
      ...
      (bvadd (bvneg (_ bv1 32)) (ite MW_S1_V2 S1_V2_!159 V2_0)))
    ...
    (($x817
      ...
      (bvsge (ite MW_S1_V1 S1_V1_!151 E1_!150)
      (bvadd (bvneg (_ bv1 32)) (ite MW_S1_V2 S1_V2_!153 V2_0))) 
    ...
    (let
    (($x1236
      (or (not (or (not R_S1_V1) (= V2_0 (bvadd (_ bv1 32) E1_!150))))
      (= S1_V2_!159 S1_V2_!153))))
    (let
    (($x913
      (or (not (or (not R_S1_V1) (= E1_!150 (bvadd (bvneg (_ bv1 32)) V2_0))))
