 ...
 (($x59848
   (forall
    ...
    (($x62661
      ...
      (= E2_!4996 (bvadd (_ bv1 32) (ite MW_S1_V3 S1_V3_!5001 E2_!4998)))
    ...
    (let
    (($x62394
      (and (not (bvsle V4_0 E2_!4995)) 
      (not (bvsle V2_0 E1_!4994)) 
      (bvsge E2_!4996 V4_0) (bvsge E1_!4994 (bvadd (bvneg (_ bv1 32)) V2_0))
      (not (bvsle V2_0 E1_!4997)) 
      (not (bvsle V4_0 E2_!4998)) 
      (not (bvsle V2_0 E1_!4999))
      (bvsge (ite MW_S1_V1 S1_V1_!5000 E1_!4999)
      (bvadd (bvneg (_ bv1 32)) (ite MW_S1_V2 S1_V2_!5002 V2_0)))
      (bvsge (ite MW_S1_V3 S1_V3_!5001 E2_!4998)
      (bvadd (bvneg (_ bv1 32)) (ite MW_S1_V4 S1_V4_!5004 V4_0))))))
    (let
    (($x62319
