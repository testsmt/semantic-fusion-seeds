...
(declare-fun x2 () Real)
(declare-fun x1 () Real)
(assert (not (exists ((ts3uscore1 Real)) (let ((?v_2 (- B)) (?v_0 (/ 1 (* 2 B)))) (let ((?v_1 (+ x1uscore2dollarskuscore6 (* (* v1uscore2dollarskuscore6 v1uscore2dollarskuscore6) ?v_0)))) (=> (and (and (and (and (and (and (and (and (and (and (=> (and (<= 0 ts3uscore1) (<= ts3uscore1 t3uscore0dollarskuscore1)) (and (>= (+ (* ?v_2 ts3uscore1) v1uscore2dollarskuscore6) 0) (<= ts3uscore1 eps))) (>= t3uscore0dollarskuscore1 0)) (< ?v_1 x2)) (< x1uscore2dollarskuscore6 x2)) (>= v1uscore2dollarskuscore6 0)) (< x1 x2)) (>= v1 0)) (> B 0)) (> eps 0)) (> A 0)) (< (+ x1 (* (* v1 v1) ?v_0)) x2)) (or (or (= v1uscore2dollarskuscore6 0) (< (+ ?v_1 (* (+ (/ A B) 1) (+ (* (* A (* eps eps)) (/ 1 2)) (* eps v1uscore2dollarskuscore6)))) x2)) (< (* (/ 1 2) (+ (+ (* ?v_2 (* t3uscore0dollarskuscore1 t3uscore0dollarskuscore1)) (* (* 2 t3uscore0dollarskuscore1) v1uscore2dollarskuscore6)) (* 2 x1uscore2dollarskuscore6))) x2))))))))
(check-sat)
(exit)
