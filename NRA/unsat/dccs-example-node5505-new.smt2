...
(assert (not (exists ((ts3uscore0 Real)) (let ((?v_0 (>= v1uscore2dollarskuscore3 0)) (?v_1 (/ 1 (* 2 B)))) (let ((?v_3 (* (* v1uscore2dollarskuscore3 v1uscore2dollarskuscore3) ?v_1))) (let ((?v_2 (+ x1uscore2dollarskuscore3 ?v_3))) (=> (and (and (and (and (and (and (and (and (and (and (and (=> (and (<= 0 ts3uscore0) (<= ts3uscore0 t3uscore0dollarskuscore0)) (and ?v_0 (<= ts3uscore0 eps))) (>= t3uscore0dollarskuscore0 0)) (= v1uscore2dollarskuscore3 0)) (< ?v_2 x2)) (< x1uscore2dollarskuscore3 x2)) ?v_0) (< x1 x2)) (>= v1 0)) (> B 0)) (> eps 0)) (> A 0)) (< (+ x1 (* (* v1 v1) ?v_1)) x2)) (or (< (+ ?v_2 (* (+ (/ A B) 1) (+ (* (* A (* eps eps)) (/ 1 2)) (* eps v1uscore2dollarskuscore3)))) x2) (< (+ (* (/ 1 2) (+ (* (* 2 t3uscore0dollarskuscore0) v1uscore2dollarskuscore3) (* 2 x1uscore2dollarskuscore3))) ?v_3) x2)))))))))
(check-sat)
(exit)
