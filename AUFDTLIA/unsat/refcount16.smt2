...
(assert (not (=> (and (= ref mk_array_2) (= valid mk_array_1)) (forall ((r resource$type)) (=> (and (not (= r null)) (= (select valid r) Truth)) (= (select count r) (S$cardinality (select handles r)))) ))))
(check-sat)
(exit)
