...
(assert (and (and (and (not (not (not (= (ite (not (= (str.at in1 1) (str.at in1 1))) 1 0) 0)))) (not (not (= (ite (<= (str.len in1) 1) 1 0) 0)))) (not (not (= (ite (<= (str.len in1) 1) 1 0) 0)))) (not (= (ite (<= (str.len in0) 1) 1 0) 0))))
