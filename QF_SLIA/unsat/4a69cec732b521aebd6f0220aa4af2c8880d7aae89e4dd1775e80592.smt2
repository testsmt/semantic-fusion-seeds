...
(assert (and (and (and (and (and (and (and (and (and (not (not (= (ite (str.contains value1 "=") 1 0) 0))) (not (not (= (ite (= (str.len value1) 0) 1 0) 0)))) (not (= (ite (not (= (str.indexof value1 "=" 0) (- 1))) 1 0) 0))) (not (not (= (ite (str.contains value1 ",") 1 0) 0)))) (not (not (= (ite (= (str.len value1) 0) 1 0) 0)))) (not (= (ite (= key1 "cache-control") 1 0) 0))) (not (= (ite (= key1 "cache-control") 1 0) 0))) (not (= (ite (= (str.len value2) 0) 1 0) 0))) (not (= (ite (= key2 "cache-control") 1 0) 0))) (not (= (ite (= key2 "cache-control") 1 0) 0))))
(check-sat)
