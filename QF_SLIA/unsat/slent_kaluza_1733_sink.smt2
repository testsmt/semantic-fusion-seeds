...
(declare-fun NEW_DGNode_39 () String)
(declare-fun NEW_DGNode_40 () String)
...
(assert (= var_0xINPUT_10485 NEW_DGNode_39))
(assert (= NEW_DGNode_39 NEW_DGNode_40))
(assert (= NEW_DGNode_39 NEW_DGNode_36))
...
(assert (= NEW_DGNode_40 (str.++ T1_44 T2_44)))
...
(assert (= I2_14 I1_14))
(assert (= I1_14 (str.len var_0xINPUT_10485))) ; len 0
...
(assert (= I2_44 I1_44))
(assert (<= T_20 I1_44))
(assert (= T_20 (str.len var_0xINPUT_10485))) ; len 0
(assert (= I1_44 (str.len var_0xINPUT_10485))) ; len 0
(assert T_1)
(assert T_2)
(assert (= T_2 (not T_1)))
(assert T_3)
...
(assert T_c)
(assert (= T_1f (str.len T1_44))) ; len 3
(assert (= I0_44 (str.len PCTEMP_LHS_8))) ; len 4
(assert T_22)
(assert T_23)
