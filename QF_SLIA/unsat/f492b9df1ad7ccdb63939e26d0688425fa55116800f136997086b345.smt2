...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (not (not (= (ite (= (str.len s) 7) 1 0) 0))) (not (not (= (ite (> (str.len s) 7) 1 0) 0)))) (not (= (ite (= (str.at s 6) (str.at t 6)) 1 0) 0))) (not (= (ite (> (str.len s) 6) 1 0) 0))) (not (= (ite (= (str.at s 5) (str.at t 5)) 1 0) 0))) (not (= (ite (> (str.len s) 5) 1 0) 0))) (not (= (ite (= (str.at s 4) (str.at t 4)) 1 0) 0))) (not (= (ite (> (str.len s) 4) 1 0) 0))) (not (= (ite (= (str.at s 3) (str.at t 3)) 1 0) 0))) (not (= (ite (> (str.len s) 3) 1 0) 0))) (not (= (ite (= (str.at s 2) (str.at t 2)) 1 0) 0))) (not (= (ite (> (str.len s) 2) 1 0) 0))) (not (= (ite (= (str.at s 1) (str.at t 1)) 1 0) 0))) (not (= (ite (> (str.len s) 1) 1 0) 0))) (not (= (ite (= (str.at s 0) (str.at t 0)) 1 0) 0))) (not (= (ite (> (str.len s) 0) 1 0) 0))) (not (not (= (ite (> (- (str.len t) (str.len s)) 1) 1 0) 0)))) (not (not (= (ite (> (str.len s) (str.len t)) 1 0) 0)))))
