...
(declare-fun NEW_DGNode_1028 () String)
(declare-fun NEW_DGNode_1078 () String)
(declare-fun NEW_DGNode_1079 () String)
...
(assert (= T_50 NEW_DGNode_1028))
(assert (= NEW_DGNode_1028 NEW_DGNode_1027))
(assert (= NEW_DGNode_1028 NEW_DGNode_359))
...
(assert (= PCTEMP_LHS_34 NEW_DGNode_1079))
(assert (= NEW_DGNode_1079 NEW_DGNode_1078))
(assert (not (str.in_re NEW_DGNode_1079 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_1078 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_1027 (str.to_re "&"))))
