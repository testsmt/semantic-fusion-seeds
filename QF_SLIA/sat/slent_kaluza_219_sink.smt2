...
(declare-fun NEW_DGNode_277 () String)
(declare-fun NEW_DGNode_278 () String)
...
(assert (= T_f NEW_DGNode_272))
(assert (= NEW_DGNode_272 NEW_DGNode_271))
(assert (= NEW_DGNode_272 NEW_DGNode_186))
...
(assert (= PCTEMP_LHS_9 NEW_DGNode_278))
(assert (= NEW_DGNode_278 NEW_DGNode_277))
(assert (not (str.in_re NEW_DGNode_278 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_277 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_271 (str.to_re "&"))))
