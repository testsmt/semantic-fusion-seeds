...
(declare-fun NEW_DGNode_660 () String)
(declare-fun NEW_DGNode_661 () String)
...
(assert (= T_1c NEW_DGNode_661))
(assert (= NEW_DGNode_661 NEW_DGNode_660))
(assert (= NEW_DGNode_661 NEW_DGNode_208))
...
(assert (= T2_44 (str.++ PCTEMP_LHS_101 T3_44)))
(assert (= PCTEMP_LHS_101 NEW_DGNode_781))
(assert (= NEW_DGNode_781 NEW_DGNode_780))
(assert (= NEW_DGNode_781 NEW_DGNode_676))
...
(assert (not (str.in_re NEW_DGNode_780 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_660 (str.to_re "&"))))
...
(assert (= I0_44 (str.len PCTEMP_LHS_101))) ; len 4
(check-sat)
(exit)
