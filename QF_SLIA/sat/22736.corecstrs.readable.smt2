...
(assert (= T_2 (str.++ "&utmn=114298117&utmcs=UTF-8&utmsr=1680x976&utmsc=24-bit&utmul=en-us&utmje=0&utmfl=-&utmdt=Ask%20A%20Word&utmhn=www.askaword.com&utmhid=22485411&utmr=0&utmp=" T_1)))
...
(assert (= T_7 (str.++ T_6 "__utma%3D169413169.771088651.1266921615.1266921615.1266921615.1%3B%2B__utmz%3D169413169.1266921615.1.1.utmccn%3D(direct)%7Cutmcsr%3D(direct)%7Cutmcmd%3D(none)%3B%2B")))
(assert (= T_9 (str.++ T1_20 T2_20)))
(assert (= T2_20 var_0xINPUT_13340))
(assert (= T1_20 "/search.jsp"))
(assert (= T_a (str.++ "&utmn=114298117&utmcs=UTF-8&utmsr=1680x976&utmsc=24-bit&utmul=en-us&utmje=0&utmfl=-&utmdt=Ask%20A%20Word&utmhn=www.askaword.com&utmhid=22485411&utmr=0&utmp=" T_9)))
(check-sat)
