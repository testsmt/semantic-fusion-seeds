...
(declare-fun NEW_DGNode_786 () String)
(declare-fun NEW_DGNode_787 () String)
...
(assert (= T_29 NEW_DGNode_658))
(assert (= NEW_DGNode_658 NEW_DGNode_657))
(assert (= NEW_DGNode_658 NEW_DGNode_230))
...
(assert (= PCTEMP_LHS_105 NEW_DGNode_787))
(assert (= NEW_DGNode_787 NEW_DGNode_786))
(assert (= NEW_DGNode_787 NEW_DGNode_682))
(assert (= NEW_DGNode_682 NEW_DGNode_681))
(assert (= NEW_DGNode_682 NEW_DGNode_679))
(assert (= NEW_DGNode_679 NEW_DGNode_678))
(assert (not (str.in_re NEW_DGNode_679 (str.to_re ""))))
(assert (not (str.in_re NEW_DGNode_678 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_681 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_786 (str.to_re "%"))))
