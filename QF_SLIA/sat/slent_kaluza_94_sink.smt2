...
(declare-fun NEW_DGNode_382 () String)
(declare-fun PCTEMP_LHS_9 () String)
(assert (= PCTEMP_LHS_9 NEW_DGNode_382))
(assert (= NEW_DGNode_382 NEW_DGNode_381))
(assert (not (str.in_re NEW_DGNode_382 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_381 (str.to_re "%"))))
