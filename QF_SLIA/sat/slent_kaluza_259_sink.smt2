...
(declare-fun NEW_DGNode_247 () String)
(declare-fun NEW_DGNode_248 () String)
(declare-fun NEW_DGNode_253 () String)
(declare-fun NEW_DGNode_254 () String)
...
(assert (= T_f NEW_DGNode_248))
(assert (= NEW_DGNode_248 NEW_DGNode_247))
(assert (= NEW_DGNode_248 NEW_DGNode_186))
...
(assert (= PCTEMP_LHS_9 NEW_DGNode_254))
(assert (= NEW_DGNode_254 NEW_DGNode_253))
(assert (not (str.in_re NEW_DGNode_254 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_253 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_247 (str.to_re "&"))))
