...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (not (not (= (ite (str.contains (str.substr (str.substr uri 10 (- (str.len uri) 10)) 0 (- 19 0)) "/") 1 0) 0))) (not (= (ite (not (= (str.len (str.substr (str.substr uri 10 (- (str.len uri) 10)) 0 (- 19 0))) 0)) 1 0) 0))) (not (= (ite (str.contains (str.substr uri 10 (- (str.len uri) 10)) ".sock") 1 0) 0))) (not (= (ite (not (= (str.len (str.substr uri 10 (- (str.len uri) 10))) 0)) 1 0) 0))) (not (= (ite (str.prefixof "mongodb://" uri) 1 0) 0))) (not (= (ite (str.prefixof "mongodb://" uri) 1 0) 0))) (not (= (ite (str.contains uri "://") 1 0) 0))) (>= 10 0)) (>= (- (str.len uri) 10) 0)) (>= 0 0)) (>= (- 19 0) 0)) (>= 10 0)) (>= (- (str.len uri) 10) 0)) (>= 0 0)) (>= (- 19 0) 0)) (>= 10 0)) (>= (- (str.len uri) 10) 0)) (>= 10 0)) (>= (- (str.len uri) 10) 0)))
(check-sat)
