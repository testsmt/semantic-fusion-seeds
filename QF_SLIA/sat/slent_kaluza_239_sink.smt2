...
(declare-fun NEW_DGNode_285 () String)
(declare-fun NEW_DGNode_286 () String)
(declare-fun NEW_DGNode_309 () String)
(declare-fun NEW_DGNode_310 () String)
...
(assert (= T_29 NEW_DGNode_286))
(assert (= NEW_DGNode_286 NEW_DGNode_285))
(assert (= NEW_DGNode_286 NEW_DGNode_230))
...
(assert (= PCTEMP_LHS_19 NEW_DGNode_310))
(assert (= NEW_DGNode_310 NEW_DGNode_309))
(assert (not (str.in_re NEW_DGNode_310 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_309 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_285 (str.to_re "&"))))
