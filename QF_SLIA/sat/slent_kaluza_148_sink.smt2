...
(declare-fun NEW_DGNode_289 () String)
(declare-fun NEW_DGNode_303 () String)
(declare-fun NEW_DGNode_304 () String)
...
(assert (= T_1c NEW_DGNode_289))
(assert (= NEW_DGNode_289 NEW_DGNode_288))
(assert (= NEW_DGNode_289 NEW_DGNode_208))
...
(assert (= PCTEMP_LHS_14 NEW_DGNode_304))
(assert (= NEW_DGNode_304 NEW_DGNode_303))
(assert (not (str.in_re NEW_DGNode_304 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_303 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_288 (str.to_re "&"))))
