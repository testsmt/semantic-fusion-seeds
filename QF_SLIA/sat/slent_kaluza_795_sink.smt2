...
(declare-fun NEW_DGNode_1490 () String)
(declare-fun NEW_DGNode_1491 () String)
...
(assert (= T_43 NEW_DGNode_1491))
(assert (= NEW_DGNode_1491 NEW_DGNode_1490))
(assert (= NEW_DGNode_1491 NEW_DGNode_337))
...
(assert (not (str.in_re NEW_DGNode_1490 (str.to_re "&"))))
