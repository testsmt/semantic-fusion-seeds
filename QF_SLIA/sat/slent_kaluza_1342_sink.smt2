...
(declare-fun var_0xINPUT_107595 () String)
(assert (= var_0xINPUT_107595 (str.++ T0_37 T1_37)))
(assert (= T1_37 (str.++ T2_37 T3_37)))
(assert (= T2_37 (str.++ T4_37 T5_37)))
(assert (not (str.in_re T4_37 (str.to_re ";"))))
(assert (= T5_37 ";"))
(assert T_1f)
...
(assert (= PCTEMP_LHS_8 (+ I0_37 PCTEMP_LHS_7)))
