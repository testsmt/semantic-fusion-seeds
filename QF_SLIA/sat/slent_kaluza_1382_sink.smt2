...
(declare-fun NEW_DGNode_1442 () String)
(declare-fun NEW_DGNode_1443 () String)
...
(assert (= T_f9 NEW_DGNode_1443))
(assert (= NEW_DGNode_1443 NEW_DGNode_1442))
(assert (= NEW_DGNode_1443 NEW_DGNode_645))
(assert (= NEW_DGNode_645 NEW_DGNode_646))
(assert (= NEW_DGNode_645 (str.++ T1_363 T2_363)))
(assert (= T2_363 (str.++ PCTEMP_LHS_96 T3_363)))
(assert (= NEW_DGNode_646 (str.++ T1_367 T2_367)))
(assert (= T2_367 (str.++ PCTEMP_LHS_99 T3_367)))
(assert (= PCTEMP_LHS_99 NEW_DGNode_1611))
...
(assert (not (str.in_re NEW_DGNode_1442 (str.to_re "&"))))
...
(assert (= I0_367 (str.len PCTEMP_LHS_99))) ; len 4
(check-sat)
(exit)
