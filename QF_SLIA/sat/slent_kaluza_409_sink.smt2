...
(declare-fun NEW_DGNode_1520 () String)
(declare-fun NEW_DGNode_1521 () String)
(declare-fun PCTEMP_LHS_24 () String)
(assert (= PCTEMP_LHS_24 NEW_DGNode_1521))
(assert (= NEW_DGNode_1521 NEW_DGNode_1520))
(assert (not (str.in_re NEW_DGNode_1521 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_1520 (str.to_re "%"))))
