...
(assert (= T1_54 (str.++ T2_54 T3_54)))
(assert (= T2_54 (str.++ T4_54 T5_54)))
(assert (not (str.in_re T4_54 (str.to_re "="))))
(assert (= T5_54 "="))
(assert T_26)
