...
(declare-fun NEW_DGNode_744 () String)
(declare-fun NEW_DGNode_745 () String)
...
(assert (= T_ab NEW_DGNode_631))
(assert (= NEW_DGNode_631 NEW_DGNode_630))
(assert (= NEW_DGNode_631 NEW_DGNode_450))
...
(assert (= PCTEMP_LHS_69 NEW_DGNode_745))
(assert (= NEW_DGNode_745 NEW_DGNode_744))
(assert (not (str.in_re NEW_DGNode_745 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_744 (str.to_re "%"))))
