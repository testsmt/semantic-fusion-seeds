...
(declare-fun NEW_DGNode_579 () String)
(declare-fun NEW_DGNode_580 () String)
(declare-fun NEW_DGNode_997 () String)
...
(assert (= T_d2 NEW_DGNode_998))
(assert (= NEW_DGNode_998 NEW_DGNode_997))
(assert (= NEW_DGNode_998 NEW_DGNode_579))
(assert (= NEW_DGNode_579 NEW_DGNode_580))
(assert (= NEW_DGNode_579 (str.++ T1_306 T2_306)))
(assert (= T2_306 (str.++ PCTEMP_LHS_81 T3_306)))
(assert (= NEW_DGNode_580 (str.++ T1_310 T2_310)))
(assert (= T2_310 (str.++ PCTEMP_LHS_84 T3_310)))
(assert (= PCTEMP_LHS_84 NEW_DGNode_1139))
(assert (= NEW_DGNode_1139 NEW_DGNode_1138))
(assert (not (str.in_re NEW_DGNode_1139 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_1138 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_997 (str.to_re "&"))))
