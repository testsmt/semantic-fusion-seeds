...
(declare-fun NEW_DGNode_1132 () String)
(declare-fun NEW_DGNode_1133 () String)
(declare-fun PCTEMP_LHS_79 () String)
(assert (= PCTEMP_LHS_79 NEW_DGNode_1133))
(assert (= NEW_DGNode_1133 NEW_DGNode_1132))
(assert (not (str.in_re NEW_DGNode_1133 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_1132 (str.to_re "%"))))
