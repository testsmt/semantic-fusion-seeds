...
(declare-fun NEW_DGNode_1030 () String)
(declare-fun NEW_DGNode_1031 () String)
(declare-fun NEW_DGNode_1072 () String)
(declare-fun NEW_DGNode_1073 () String)
...
(assert (= T_43 NEW_DGNode_1031))
(assert (= NEW_DGNode_1031 NEW_DGNode_1030))
(assert (= NEW_DGNode_1031 NEW_DGNode_337))
...
(assert (= PCTEMP_LHS_29 NEW_DGNode_1073))
(assert (= NEW_DGNode_1073 NEW_DGNode_1072))
(assert (not (str.in_re NEW_DGNode_1073 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_1072 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_1030 (str.to_re "&"))))
