...
(assert (and (and (and (and (and (and (and (and (not (not (not (= (ite (= (str.at value1 0) "\u{b}") 1 0) 0)))) (not (not (= (ite (= (str.at value1 0) "\u{d}") 1 0) 0)))) (not (not (= (ite (= (str.at value1 0) "\u{a}") 1 0) 0)))) (not (not (= (ite (= (str.at value1 0) "\u{9}") 1 0) 0)))) (not (not (= (ite (= (str.at value1 0) " ") 1 0) 0)))) (not (not (= (ite (= (str.len value1) 0) 1 0) 0)))) (not (not (= (ite (str.contains value1 ",") 1 0) 0)))) (not (not (= (ite (= (str.len value1) 0) 1 0) 0)))) (not (= (ite (= key1 "connection") 1 0) 0))))
(check-sat)
