...
(assert (= PCTEMP_LHS_4 NEW_DGNode_37))
(assert (= NEW_DGNode_37 NEW_DGNode_36))
(assert (= NEW_DGNode_37 (str.++ T_d NEW_DGNode_21)))
...
(assert (not (str.in_re NEW_DGNode_36 (str.to_re "%"))))
