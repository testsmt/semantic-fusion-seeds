...
(assert (and (and (and (and (and (and (<= (+ (str.len var_2) (- 1) ) 0 ) (<= 0  (+ (str.len var_2) (- 1) ))) (and (<= (+ (str.len var_3) (- 1) ) 0 ) (<= 0  (+ (str.len var_3) (- 1) )))) (and (<= (+ (+ (str.len var_4) (* (- 1)  (str.len var_0))) 1 ) 0 ) (<= 0  (+ (+ (str.len var_4) (* (- 1)  (str.len var_0))) 1 )))) (and (<= (+ (+ (str.len var_5) (* (- 1)  (str.len var_1))) 1 ) 0 ) (<= 0  (+ (+ (str.len var_5) (* (- 1)  (str.len var_1))) 1 )))) (<= 0  (+ (str.len var_0) (- 1) ))) (<= 0  (+ (str.len var_1) (- 1) ))))
(check-sat)
(exit)
