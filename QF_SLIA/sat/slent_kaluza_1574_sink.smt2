...
(assert (= PCTEMP_LHS_4 NEW_DGNode_31))
(assert (= NEW_DGNode_31 NEW_DGNode_30))
(assert (= NEW_DGNode_31 (str.++ T_d NEW_DGNode_21)))
...
(assert (not (str.in_re NEW_DGNode_30 (str.to_re "%"))))
