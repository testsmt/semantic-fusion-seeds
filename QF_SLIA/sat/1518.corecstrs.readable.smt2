...
(assert T_8)
(assert (= T_9 (not (= var_0xINPUT_118649 "YY8CBEMy6Q"))))
(assert T_9)
(assert (= T_a (= var_0xINPUT_118649 "")))
(assert (= T_b (not T_a)))
(assert T_b)
(assert (= T_c (not (= "" var_0xINPUT_118649))))
(assert T_c)
(assert (= T_d (not (= "" var_0xINPUT_118649))))
(assert T_d)
(assert (= T_e (not (= var_0xINPUT_118649 ""))))
(assert T_e)
(assert (= T_f (= var_0xINPUT_118649 "")))
(assert (= T_10 (not T_f)))
(assert T_10)
(assert (= T_11 (not (= var_0xINPUT_118649 ""))))
(assert T_11)
(check-sat)
