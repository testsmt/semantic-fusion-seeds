...
(declare-fun NEW_DGNode_373 () String)
(declare-fun NEW_DGNode_387 () String)
(declare-fun NEW_DGNode_388 () String)
...
(assert (= T_1c NEW_DGNode_373))
(assert (= NEW_DGNode_373 NEW_DGNode_372))
(assert (= NEW_DGNode_373 NEW_DGNode_271))
...
(assert (= PCTEMP_LHS_14 NEW_DGNode_388))
(assert (= NEW_DGNode_388 NEW_DGNode_387))
(assert (not (str.in_re NEW_DGNode_388 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_387 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_372 (str.to_re "&"))))
