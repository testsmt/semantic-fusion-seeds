...
(declare-fun NEW_DGNode_308 () String)
(declare-fun NEW_DGNode_331 () String)
(declare-fun NEW_DGNode_332 () String)
...
(assert (= T_29 NEW_DGNode_308))
(assert (= NEW_DGNode_308 NEW_DGNode_307))
(assert (= NEW_DGNode_308 NEW_DGNode_230))
...
(assert (= PCTEMP_LHS_19 NEW_DGNode_332))
(assert (= NEW_DGNode_332 NEW_DGNode_331))
(assert (not (str.in_re NEW_DGNode_332 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_331 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_307 (str.to_re "&"))))
