...
(assert (= T_f NEW_DGNode_354))
(assert (= NEW_DGNode_354 NEW_DGNode_353))
(assert (= NEW_DGNode_354 NEW_DGNode_249))
...
(assert (= PCTEMP_LHS_9 NEW_DGNode_360))
(assert (= NEW_DGNode_360 NEW_DGNode_359))
(assert (not (str.in_re NEW_DGNode_360 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_359 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_353 (str.to_re "&"))))
