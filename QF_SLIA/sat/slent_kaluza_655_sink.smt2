...
(declare-fun NEW_DGNode_1066 () String)
(declare-fun NEW_DGNode_1067 () String)
(declare-fun PCTEMP_LHS_24 () String)
(assert (= PCTEMP_LHS_24 NEW_DGNode_1067))
(assert (= NEW_DGNode_1067 NEW_DGNode_1066))
(assert (not (str.in_re NEW_DGNode_1067 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_1066 (str.to_re "%"))))
