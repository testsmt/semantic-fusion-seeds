...
(declare-fun NEW_DGNode_1006 () String)
(declare-fun NEW_DGNode_1007 () String)
(declare-fun NEW_DGNode_1120 () String)
(declare-fun NEW_DGNode_1121 () String)
(declare-fun NEW_DGNode_513 () String)
...
(assert (= T_ab NEW_DGNode_1007))
(assert (= NEW_DGNode_1007 NEW_DGNode_1006))
(assert (= NEW_DGNode_1007 NEW_DGNode_513))
(assert (= NEW_DGNode_513 NEW_DGNode_514))
(assert (= NEW_DGNode_513 (str.++ T1_249 T2_249)))
(assert (= T2_249 (str.++ PCTEMP_LHS_66 T3_249)))
(assert (= NEW_DGNode_514 (str.++ T1_253 T2_253)))
(assert (= T2_253 (str.++ PCTEMP_LHS_69 T3_253)))
(assert (= PCTEMP_LHS_69 NEW_DGNode_1121))
(assert (= NEW_DGNode_1121 NEW_DGNode_1120))
(assert (not (str.in_re NEW_DGNode_1121 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_1120 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_1006 (str.to_re "&"))))
