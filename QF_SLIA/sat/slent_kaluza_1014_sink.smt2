...
(assert (= var_0xINPUT_126249 (str.++ T0_8 T1_8)))
(assert (= T1_8 (str.++ T2_8 T3_8)))
(assert (= T2_8 (str.++ T4_8 T5_8)))
(assert (not (str.in_re T4_8 (str.to_re ";"))))
(assert (= T5_8 ";"))
(assert T_8)
(assert (= T_8 (not T_7)))
...
(assert (= PCTEMP_LHS_2 (+ I0_8 PCTEMP_LHS_1)))
...
(assert (= I0_8 (str.len T4_8))) ; len 1
(assert T_SELECT_2)
(check-sat)
(exit)
