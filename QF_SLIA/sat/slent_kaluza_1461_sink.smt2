...
(assert (= PCTEMP_LHS_4 NEW_DGNode_40))
(assert (= NEW_DGNode_40 NEW_DGNode_39))
(assert (= NEW_DGNode_40 (str.++ T_d NEW_DGNode_21)))
...
(assert (not (str.in_re NEW_DGNode_39 (str.to_re "%"))))
