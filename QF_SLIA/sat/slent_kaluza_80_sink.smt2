...
(declare-fun NEW_DGNode_268 () String)
(declare-fun NEW_DGNode_269 () String)
(declare-fun NEW_DGNode_283 () String)
(declare-fun NEW_DGNode_284 () String)
...
(assert (= T_1c NEW_DGNode_269))
(assert (= NEW_DGNode_269 NEW_DGNode_268))
(assert (= NEW_DGNode_269 NEW_DGNode_208))
...
(assert (= PCTEMP_LHS_14 NEW_DGNode_284))
(assert (= NEW_DGNode_284 NEW_DGNode_283))
(assert (not (str.in_re NEW_DGNode_284 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_283 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_268 (str.to_re "&"))))
