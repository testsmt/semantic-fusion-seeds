...
(declare-fun var_0xINPUT_42055 () String)
(assert (= var_0xINPUT_42055 (str.++ T0_20 T1_20)))
(assert (= T1_20 (str.++ T2_20 T3_20)))
(assert (= T2_20 (str.++ T4_20 T5_20)))
(assert (not (str.in_re T4_20 (str.to_re "__utma=218069774."))))
(assert (= T5_20 "__utma=218069774."))
(assert T_11)
