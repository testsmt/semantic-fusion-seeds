...
(assert (= PCTEMP_LHS_4 NEW_DGNode_49))
(assert (= NEW_DGNode_49 NEW_DGNode_48))
(assert (= NEW_DGNode_49 (str.++ T_d NEW_DGNode_21)))
...
(assert (not (str.in_re NEW_DGNode_48 (str.to_re "%"))))
