...
(assert (= a_100 (store a_99 i9 e9)))
(assert (= a_101 (store a_100 i10 e10)))
(assert (= a_102 (store a1 i9 e9)))
(assert (= a_103 (store a_102 i6 e6)))
(assert (= a_104 (store a_103 i7 e7)))
(assert (= a_105 (store a_104 i8 e8)))
(assert (= a_106 (store a_105 i2 e2)))
(assert (= a_107 (store a_106 i5 e5)))
(assert (= a_108 (store a_107 i3 e3)))
(assert (= a_109 (store a_108 i10 e10)))
(assert (= a_110 (store a_109 i4 e4)))
(assert (= a_111 (store a_110 i1 e1)))
(assert (= a_92 (store a1 i1 e1)))
(assert (= a_93 (store a_92 i2 e2)))
(assert (= a_94 (store a_93 i3 e3)))
(assert (= a_95 (store a_94 i4 e4)))
(assert (= a_96 (store a_95 i5 e5)))
(assert (= a_97 (store a_96 i6 e6)))
(assert (= a_98 (store a_97 i7 e7)))
(assert (= a_99 (store a_98 i8 e8)))
