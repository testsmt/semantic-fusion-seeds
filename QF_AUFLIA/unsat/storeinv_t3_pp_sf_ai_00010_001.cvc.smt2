...
(assert (= a_29 (store a_25 i8 e_28)))
(assert (= a_3 (store a2 i1 e_2)))
(assert (= a_31 (store a_27 i8 e_30)))
(assert (= a_33 (store a_29 i9 e_32)))
(assert (= a_35 (store a_31 i9 e_34)))
(assert (= a_37 (store a_33 i10 e_36)))
(assert (= a_39 (store a_35 i10 e_38)))
...
(assert (= e_32 (select a_31 i9)))
(assert (= e_34 (select a_29 i9)))
(assert (= e_36 (select a_35 i10)))
(assert (= e_38 (select a_33 i10)))
(assert (= e_4 (select a_3 i2)))
(assert (= e_41 (select a1 i_40)))
(assert (= e_42 (select a2 i_40)))
(assert (= e_6 (select a_1 i2)))
(assert (= e_8 (select a_7 i3)))
(assert (= i_40 (sk a1 a2)))
(assert (= a_37 a_39))
