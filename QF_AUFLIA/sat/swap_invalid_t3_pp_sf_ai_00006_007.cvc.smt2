...
(assert (= a_169 (store a1 i4 e_168)))
(assert (= a_171 (store a_169 i5 e_170)))
...
(assert (= a_187 (store a_185 i4 e_186)))
(assert (= a_189 (store a_187 i5 e_188)))
(assert (= a_191 (store a_189 i0 e_190)))
(assert (= a_192 (store a_171 i0 e_174)))
(assert (= a_193 (store a_192 i2 e_172)))
(assert (= a_195 (store a_193 i0 e_194)))
(assert (= a_197 (store a_195 i5 e_196)))
(assert (= a_199 (store a_197 i3 e_198)))
(assert (= a_201 (store a_199 i1 e_200)))
(assert (= a_203 (store a_201 i4 e_202)))
(assert (= a_205 (store a_203 i3 e_204)))
(assert (= a_207 (store a_205 i5 e_206)))
(assert (= a_209 (store a_207 i1 e_208)))
(assert (= e_168 (select a1 i5)))
(assert (= e_170 (select a1 i4)))
(assert (= e_172 (select a_171 i0)))
(assert (= e_174 (select a_171 i2)))
(assert (= e_176 (select a_175 i0)))
(assert (= e_178 (select a_175 i5)))
(assert (= e_180 (select a_179 i1)))
(assert (= e_182 (select a_179 i3)))
(assert (= e_184 (select a_183 i4)))
(assert (= e_186 (select a_183 i3)))
(assert (= e_188 (select a_187 i0)))
(assert (= e_190 (select a_187 i5)))
(assert (= e_194 (select a_193 i5)))
(assert (= e_196 (select a_193 i0)))
(assert (= e_198 (select a_197 i1)))
(assert (= e_200 (select a_197 i3)))
(assert (= e_202 (select a_201 i3)))
(assert (= e_204 (select a_201 i4)))
(assert (= e_206 (select a_205 i1)))
(assert (= e_208 (select a_205 i5)))
(assert (= e_211 (select a_191 i_210)))
(assert (= e_212 (select a_209 i_210)))
(assert (= i_210 (sk a_191 a_209)))
(assert (not (= e_211 e_212)))
(check-sat)
(exit)
