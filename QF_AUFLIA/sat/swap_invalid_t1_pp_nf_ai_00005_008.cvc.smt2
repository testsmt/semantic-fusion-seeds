...
(assert (let ((?v_0 (select a1 i2))) (let ((?v_1 (store (store a1 i2 ?v_0) i2 ?v_0))) (let ((?v_2 (select ?v_1 i4))) (let ((?v_3 (store (store ?v_1 i4 ?v_2) i4 ?v_2))) (let ((?v_4 (store (store ?v_3 i4 (select ?v_3 i1)) i1 (select ?v_3 i4)))) (let ((?v_5 (select ?v_4 i2))) (let ((?v_6 (store (store ?v_4 i2 ?v_5) i2 ?v_5))) (let ((?v_8 (select ?v_6 i2))) (let ((?v_7 (store (store ?v_6 i1 ?v_8) i2 (select ?v_6 i1))) (?v_9 (store (store ?v_6 i2 ?v_8) i2 ?v_8))) (let ((?v_10 (sk ?v_7 ?v_9))) (not (= (select ?v_7 ?v_10) (select ?v_9 ?v_10))))))))))))))
(check-sat)
(exit)
