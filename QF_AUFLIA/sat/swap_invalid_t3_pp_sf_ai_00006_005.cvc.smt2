...
(assert (= a_342 (store a1 i5 e_341)))
(assert (= a_344 (store a_342 i3 e_343)))
...
(assert (= a_354 (store a_352 i4 e_353)))
(assert (= a_356 (store a_354 i0 e_355)))
(assert (= a_358 (store a_356 i4 e_357)))
(assert (= a_360 (store a_358 i5 e_359)))
(assert (= a_362 (store a_360 i2 e_361)))
(assert (= a_364 (store a_362 i0 e_363)))
(assert (= a_365 (store a1 i3 e_343)))
(assert (= a_366 (store a_365 i5 e_341)))
(assert (= a_368 (store a_366 i1 e_367)))
(assert (= a_370 (store a_368 i0 e_369)))
(assert (= a_372 (store a_370 i4 e_371)))
(assert (= a_374 (store a_372 i1 e_373)))
(assert (= a_376 (store a_374 i4 e_375)))
(assert (= a_378 (store a_376 i0 e_377)))
(assert (= a_380 (store a_378 i4 e_379)))
(assert (= a_382 (store a_380 i5 e_381)))
(assert (= a_384 (store a_382 i1 e_383)))
(assert (= a_386 (store a_384 i2 e_385)))
(assert (= e_341 (select a1 i3)))
(assert (= e_343 (select a1 i5)))
(assert (= e_345 (select a_344 i1)))
(assert (= e_347 (select a_344 i0)))
(assert (= e_349 (select a_348 i4)))
(assert (= e_351 (select a_348 i1)))
(assert (= e_353 (select a_352 i0)))
(assert (= e_355 (select a_352 i4)))
(assert (= e_357 (select a_356 i5)))
(assert (= e_359 (select a_356 i4)))
(assert (= e_361 (select a_360 i0)))
(assert (= e_363 (select a_360 i2)))
(assert (= e_367 (select a_366 i0)))
(assert (= e_369 (select a_366 i1)))
(assert (= e_371 (select a_370 i1)))
(assert (= e_373 (select a_370 i4)))
(assert (= e_375 (select a_374 i0)))
(assert (= e_377 (select a_374 i4)))
(assert (= e_379 (select a_378 i5)))
(assert (= e_381 (select a_378 i4)))
(assert (= e_383 (select a_382 i2)))
(assert (= e_385 (select a_382 i1)))
(assert (= e_388 (select a_364 i_387)))
(assert (= e_389 (select a_386 i_387)))
(assert (= i_387 (sk a_364 a_386)))
(assert (not (= e_388 e_389)))
(check-sat)
(exit)
