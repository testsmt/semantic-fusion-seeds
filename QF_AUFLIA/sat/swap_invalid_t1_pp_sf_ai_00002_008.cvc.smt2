...
(assert (= a_24 (store a_22 i0 e_23)))
(assert (= e_12 (select a1 i1)))
(assert (= e_14 (select a1 i0)))
(assert (= e_16 (select a_15 i1)))
(assert (= e_21 (select a_20 i0)))
(assert (= e_23 (select a_20 i1)))
(assert (= e_26 (select a_18 i_25)))
(assert (= e_27 (select a_24 i_25)))
(assert (= i_25 (sk a_18 a_24)))
(assert (not (= e_26 e_27)))
(check-sat)
(exit)
