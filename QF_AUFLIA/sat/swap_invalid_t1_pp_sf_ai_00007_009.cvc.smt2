...
(assert (= a_45 (store a_43 i4 e_44)))
...
(assert (= e_42 (select a_41 i4)))
(assert (= e_44 (select a_41 i0)))
(assert (= e_47 (select a_27 i_46)))
(assert (= e_48 (select a_45 i_46)))
(assert (= e_6 (select a_3 i5)))
(assert (= e_8 (select a_7 i1)))
(assert (= i_46 (sk a_27 a_45)))
(assert (not (= e_47 e_48)))
(check-sat)
(exit)
