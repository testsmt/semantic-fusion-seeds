...
(assert (= a_28 (store a_27 i0 e_26)))
...
(assert (= e_26 (select a_25 i0)))
(assert (= e_30 (select a_15 i_29)))
(assert (= e_31 (select a_28 i_29)))
(assert (= e_4 (select a_3 i2)))
(assert (= e_6 (select a_3 i0)))
(assert (= e_8 (select a_7 i3)))
(assert (= i_29 (sk a_15 a_28)))
(assert (not (= e_30 e_31)))
(check-sat)
(exit)
