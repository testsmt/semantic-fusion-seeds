...
(declare-fun e_517 () Int)
(declare-fun i_515 () Int)
...
(assert (= a_474 (store a1 i0 e_473)))
(assert (= a_476 (store a_474 i6 e_475)))
(assert (= a_478 (store a_476 i2 e_477)))
(assert (= a_480 (store a_478 i3 e_479)))
(assert (= a_482 (store a_480 i3 e_481)))
(assert (= a_484 (store a_482 i2 e_483)))
(assert (= a_486 (store a_484 i3 e_485)))
(assert (= a_488 (store a_486 i5 e_487)))
(assert (= a_490 (store a_488 i3 e_489)))
(assert (= a_492 (store a_490 i1 e_491)))
(assert (= a_494 (store a_492 i1 e_493)))
(assert (= a_496 (store a_494 i2 e_495)))
(assert (= a_498 (store a_496 i0 e_497)))
(assert (= a_500 (store a_498 i5 e_499)))
(assert (= a_501 (store a_484 i5 e_487)))
(assert (= a_502 (store a_501 i3 e_485)))
(assert (= a_504 (store a_502 i1 e_503)))
(assert (= a_506 (store a_504 i3 e_505)))
(assert (= a_508 (store a_506 i2 e_507)))
(assert (= a_510 (store a_508 i1 e_509)))
(assert (= a_512 (store a_510 i0 e_511)))
(assert (= a_514 (store a_512 i6 e_513)))
(assert (= e_473 (select a1 i6)))
(assert (= e_475 (select a1 i0)))
(assert (= e_477 (select a_476 i3)))
(assert (= e_479 (select a_476 i2)))
(assert (= e_481 (select a_480 i2)))
(assert (= e_483 (select a_480 i3)))
(assert (= e_485 (select a_484 i5)))
(assert (= e_487 (select a_484 i3)))
(assert (= e_489 (select a_488 i1)))
(assert (= e_491 (select a_488 i3)))
(assert (= e_493 (select a_492 i2)))
(assert (= e_495 (select a_492 i1)))
(assert (= e_497 (select a_496 i5)))
(assert (= e_499 (select a_496 i0)))
(assert (= e_503 (select a_502 i3)))
(assert (= e_505 (select a_502 i1)))
(assert (= e_507 (select a_506 i1)))
(assert (= e_509 (select a_506 i2)))
(assert (= e_511 (select a_510 i6)))
(assert (= e_513 (select a_510 i0)))
(assert (= e_516 (select a_500 i_515)))
(assert (= e_517 (select a_514 i_515)))
(assert (= i_515 (sk a_500 a_514)))
(assert (not (= e_516 e_517)))
(check-sat)
(exit)
